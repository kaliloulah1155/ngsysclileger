...
<!--INCLUDE ABASS-->
		<!-- Code de la couleur verte du menu et autres : #1bbc9b -->
		
		<!-- Latest compiled and minified CSS for abass portlet -->
	...
	<link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/form_builder.css"/>
		...
		<!--menugrisboot de M FLEUROT Dominique -->	
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<link rel="stylesheet" href="/{NOM_APPLICATION}/include/menugrisboot/index_files/mbcsmbmcp.css" type="text/css" />
		<!--des polices à utiliser -->	
		<link href="http://fonts.googleapis.com/css?family=Roboto:400,300,500,700" rel="stylesheet" type="text/css" />
		<link href="https://fonts.googleapis.com/css?family=Raleway:400,300,500,600,700,800,900" rel="stylesheet" type="text/css"/>
		<link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css" />
		<!--menu déroulant bootstrap simplement. mais avec sousmenu déroulant le fichier submenu.css obligatoir -->
		<link rel="stylesheet" href="/{NOM_APPLICATION}/include/bootstrap-3.3.7/abass/submenu.css" type="text/css" />
		<link href="/{NOM_APPLICATION}/include/ressources/plugins/all/css/local/bootstrap.css" rel="stylesheet" type="text/css" />
		<!--icônes vectorielles-->
		<link href="/{NOM_APPLICATION}/include/fontawesome-free-5.8.2-web/css/all.css" rel="stylesheet">
		...
		<link href="/{NOM_APPLICATION}/include/ressources/plugins/all/css/system/css/system.css" rel="stylesheet" type="text/css" />
		...
		<link href="/{NOM_APPLICATION}/include/ressources/plugins/all/css/sp_social.css" rel="stylesheet" type="text/css" />
		<!--animations-->
		<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/ressources/plugins/css/animate.css" />
		<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/ressources/css/index.css" />
		<!--style-->
		...
		<!--script-->
		<script src="/{NOM_APPLICATION}/include/bootstrap-3.3.7/dist/js/bootstrap.min.js"></script>
		<script src="/{NOM_APPLICATION}/include/jQuery/jquery.min.js"></script>
	...
	<div id='div_center' style="background-color: transparent;border: none;" class="divs_center yui-navset"> 
		...
		<div class="yui-content" id="nav-content" style="height: 98%;background-color: transparent;">  
			<div id="tab_centerbal"  style="height: 100%;background-color: transparent;">
				<!-- ICI --- iframe  affiche les elements de la page d accueil-->
				...
				<div class="container-fluid col-md-12 col-sm-12">
					<div class="form_builder" style="margin-top: 25px">
						<div class="row">
							...
							<div style="background-color:#1bbc9b; color:white;" class="navbar navbar-default t3-mainnav marginBottom-0 col-md-2 col-sm-12 col-xs-12 " role="navigation">
								<div class="navbar-header">
									<button title="Clicquez ici pour voir le menu du drag and drop" style="float:left;" type="button" class="btn navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse-ID1">
								...
								<nav class="collapse navbar-collapse" id="navbar-collapse-ID1">
									<ul   class="nav navbar-nav level0 nav-tabs">
										<li class="form_bal_textfield col-sm-12" >
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/balgenerale.gif" border='0' > Boite aux lettres</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/profil.gif" border='0'> Profils</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/panier.gif" border='0'> Panier</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/list_bib_priv.gif" border='0'> Questions privÃ©es</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/folderopen.gif" border='0'> Contenu d'un dossiers</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/list_bib_part.gif" border='0'> Questions publiques</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/rss.gif" border='0'> RSS</a>
										</li>
										<li class="form_bal_textfield col-sm-12">
											<a href="javascript:;" style="color:white;"><img src="../../../../images/portail/reponse.gif" border='0'> RÃ©ponses Ã  une question</a>
										</li>
									</ul>
								</nav>
							</div>
							
							<div class="col-md-3 col-sm-12"  style="margin:0.3%;">
							...
							<div class="col-md-4 col-sm-12"  style="margin:0.3%;">
