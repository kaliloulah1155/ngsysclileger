...
<head>
	...
	<!--INCLUDE ABASS-->
		...
		<!--des polices à utiliser -->	
		<link href="http://fonts.googleapis.com/css?family=Roboto:400,300,500,700" rel="stylesheet" type="text/css" />
		<link href="https://fonts.googleapis.com/css?family=Raleway:400,300,500,600,700,800,900" rel="stylesheet" type="text/css"/>
		<link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css" />
		
		<!--menu déroulant bootstrap simplement mais sousmenu déroulant (submenu.css obligatoir) design-->
		<link rel="stylesheet" href="../../../../include/bootstrap-3.3.7/abass/submenu.css" type="text/css" />
		<link href="../../../../include/ressources/plugins/all/css/local/bootstrap.css" rel="stylesheet" type="text/css" />
		
		<!--icônes vectorielles-->
		<link href="../../../../include/fontawesome-free-5.8.2-web/css/all.css" rel="stylesheet">
		
		<!--systems et tpl important pour la couleur verte generale du site-->
		<link href="../../../../include/ressources/plugins/all/css/system/css/system.css" rel="stylesheet" type="text/css" />
		<link href="../../../../include/ressources/plugins/all/css/local/template.css" rel="stylesheet" type="text/css" />
		
		<!--gere le top bar avec les icons de fb, twitter, ...-->
		<link href="../../../../include/ressources/plugins/all/css/sp_social.css" rel="stylesheet" type="text/css" />
		
		<!--animations-->
		<link rel="stylesheet" type="text/css" href="../../../../include/ressources/plugins/css/animate.css" />
		<link rel="stylesheet" type="text/css" href="../../../../include/ressources/css/index.css" />
	...
	var toggleEdition = function (button) {
		...
		if (editing) {
		    button.style.backgroundImage = 'url('+ icon_path + 'plus.gif)';
		} else {
		    button.style.backgroundImage = 'url('+ icon_path + 'moins.gif)';
		}
...
<title>{TITRE_PAGE}</title>
	...
	<link href="../../../../include/bootstrapSortablePortlet/bootstrap.sortable.min.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/myStyle.css"/>
    <link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/bootstrap.min.css"/>
	<link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/tether.min.css"/>
	<link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/font-awesome/css/font-awesome.min.css"/>
	<link rel="stylesheet" href="../../../../include/bootstrapSortablePortlet/css/form_builder.css"/>
	<style>
        .table-sortable {
            position: relative;
        }
...
<!--<link href='/{NOM_APPLICATION}/include/script/menu_toolbar/css/menu.css' type='text/css' rel='STYLESHEET' />-->
<link rel="stylesheet" href="/{NOM_APPLICATION}/include/script/menu_toolbar/index_files/mbcsmbmcp.css" type="text/css" />
...
function afficherRechercheTexte()
{
    ...
    else 
    {
        ...
        szUrl += "&POS_CHOIX_LIB=" + escape("COA;COD;NOT;CTC;");
        szUrl += "&POS_TRI=0";
...
<body class='accueil yui-skin-sam container-fluid body_portlet_admin{IS_USER_ADMIN}' style="margin-top: 0;background-color: transparent;" onLoad="initEcran();" onResize="testpositionnement();" onBeforeUnLoad='onUnload();'>
	<form name="principal">
		...
		<div class="container">
			...
			<div class="t3-spotlight t3-topbar  row">
				<div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="t3-module module top-social " id="Mod178">
							...
							<div class="module-ct">
								<div id="sp_social178" class="sp_social icon_size_32  top-social">
									<ul>
										...
										<li><a target='_blank' title="Gmail" href="https://plus.google.com/#"><i class="fa fa-google-plus"></i></a></li>
										<li><a target='_blank' title="Linkedin" href="http://www.linkedin.com/#"><i class="fa fa-linkedin"></i></a></li>
										<li><a target='_blank' title="WhatsApp" href="http://www.dribbble.com/#"><i class="fa fa-whatsapp"></i></a></li>
									</ul>
				...
				<div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="t3-module module " id="Mod179">
						<div class="module-inner">
							<div class="module-ct">
								<ul class="nav menu">
									<li class="item-608"><a href="#" class="">Politiques &amp; confidentialités </a></li>
									<li class="item-609"><a href="#" class="">Faire une suggestion </a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="caption">
									<div class="all_div">
										<div class="row li_row">
											<div class="col-md-12">
												<h3 class="pull-left">Titre portlet Sesin 2</h3>
												<button type="button" class="btn btn-primary btn-circle btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-times"></i></button>
												<button type="button" class="btn btn-primary btn-circle btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-info"></i></button>
												<button type="button" class="btn btn-primary btn-circle btn-sm remove_bal_field pull-right" data-field="' + field + '"><i class="fa fa-plus"></i></button>
											</div>
										</div>
										<hr/>
									</div>
									...
									<div class="row li_row form_output" data-type="text" data-field="' + field + '">
										<div class="col-md-12">
											<div class="" style="overflow: auto; max-height: 150px;"> 
												<ul style="margin: 0; padding: 0">
													<li style="list-style: none outside none; margin: 3px; font-size: 80%">
														<img src="../../../../images/portail/puce.gif" border='0'><a href="javascript:void(0)" onClick="javascript: void afficherResultat('{PORTLET_TYPE}', '{URL_ELEMENT}');"><b>{LIBELLE_MARQUE}</b>{LIBELLE}</a>
													</li>
												</ul>
											</div>
										</div>
	...
	<div class="container-fluid col-md-12 col-sm-12">
		<div class="form_builder" style="margin-top: 25px">
			<div class="row">
				...
				<div class="navbar navbar-default t3-mainnav marginBottom-0 col-md-2 col-sm-12 col-xs-12 " role="navigation">
					<div class="navbar-header">
						<button title="Clicquez ici pour voir les onglets" style="float:left;" type="button" class="btn navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse-ID1">
							<i class="fa fa-bars fa-lg"></i> 
						</button>
					</div>
					<nav class="collapse navbar-collapse" id="navbar-collapse-ID1">
						<ul class="nav navbar-nav level0 nav-tabs">
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/balgenerale.gif" border='0'> Boite aux lettres</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/profil.gif" border='0'> Profils</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/panier.gif" border='0'> Panier</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/list_bib_priv.gif" border='0'> Questions privÃ©es</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/folderopen.gif" border='0'> Contenu d'un dossiers</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/list_bib_part.gif" border='0'> Questions publiques</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/rss.gif" border='0'> RSS</a>
							</li>
							<li class="form_bal_textfield col-sm-12">
								<a href="javascript:;"><img src="../../../../images/portail/reponse.gif" border='0'> RÃ©ponses Ã  une question</a>
							</li>
						</ul>
					</nav>
				</div>
				...
				<div class="col-md-3 col-sm-12"  style="margin-left:0.3%;">
					<div class="form_builder_area"></div>
				</div>
			...
			<table width="100%" class="containertoolbar" border='0' height='40px' cellspacing='0' cellpadding='0'>
				<tr>
					<td  style=" padding:10px 0;" >
						<!--<div id="menu_toolbar" align="left">{CONTENU_MENU}</div>-->
						<div id="menu_toolbar" >{CONTENU_MENU}</div>
					</td>
				</tr> 
			</table>
		</div>
	...
	<div id='div_center' style="background-color: transparent;" class="divs_center">
		...
		<iframe src='{URL_CENTER}' style='height: 100%;width: 98%;margin-left:10px;' frameborder='0' id='ifr_center' name='center'></iframe>
	...
	<div id='div_center' style="background-color: transparent;border: none;" class="divs_center yui-navset"> 
		...
		<div class="yui-content" id="nav-content" style="height: 98%;background-color: transparent;">  
			<div id="tab_centerbal"  style="height: 100%;background-color: transparent;">
				<!-- iframe  affiche les elements de la page d accueil-->
				<iframe src='' allowTransparency="true" style='height: 100%; width:98%;margin-left:10px;' frameborder='0' id='ifr_centerbal' name='centerbal'></iframe>
			</div>
			<iframe src='{URL_CENTER}' style='height: 100%;width: 98%;margin-left:10px; display:none;' frameborder='0' id='ifr_center' name='center'></iframe>
		</div> 
	</div>
...
<script type="text/javascript">
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
		...
		<script src="../../../../include/bootstrapSortablePortlet/js/jquery.min.js"></script>
        <script src="../../../../include/bootstrapSortablePortlet/js/jquery-ui.min.js"></script>
        <script src="../../../../include/bootstrapSortablePortlet/js/tether.min.js"></script>
        <script src="../../../../include/bootstrapSortablePortlet/js/bootstrap.min.js"></script>
        <script src="../../../../include/bootstrapSortablePortlet/js/form_builder.js"></script>
