...
function afficherRechercheTexte()
{
    ...
    else 
    {
       ...
       // szUrl += "&POS_CHOIX_LIB=" + escape("PRS;COD;EML;NOT");
       szUrl += "&POS_CHOIX_LIB=" + escape("PRS");
        szUrl += "&POS_TRI=0";
        ...
        <div id='leftPanel'>
            <div id='arborescence' class="ui-layout-center" style="background-color: transparent;border-radius: 2px;border: 2px solid #4a67b3;margin-top: 7%;">
                ...
                <section class="active">
                     <a class="btn" style="width: 100%; height: 5vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;" href="javascript:void(0);" 
                     onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/question/afficher_question.php');"
                     >
                    ...
                    <ul class="nav-list" id="nav-listRcrs" style="display:none; margin-top: -2%;">
                       <li style="padding-top: 3%">
                            ...
                            <ul class="nav-link" id="nav-linkRcrs1" style="display: none; left: 0;">
                                ...
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=FPO');">Fiche de poste</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                ...
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=POS');">Poste</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                        ...
                        <li style="padding-top: 3%">
                            ...
                            <ul class="nav-link" id="nav-linkRcrs2" style="display: none; left: 0;">
                                ...
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=FRS');">Frais de mission</a>
                                </li>     
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                 ...
                                 <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=REG');">Registre employeur</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3%">
                            ...
                            <ul class="nav-link" id="nav-linkRcrs3" style="display: none; left: 0;">
                                ...
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                 ...
                                 <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/recherche/afficher_recherche_fiche.php?POS_TYPEDOC=PAY');">Bulletin de salaire</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=TAI');">Paiement mensuel</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=DIS');">E-DISA</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
