...
<div id='toolbar1' role="banner" style="display: none;" title="Entete">
    ...
    <table role='presentation' class="containertoolbar">
        <tr style='vertical-align: middle;'>
            <td class="menu_logo_version" style="cursor: pointer;" title="{LIBELLE_VERSION}" onClick="afficherVersion();">
                <img src="../../../../images/logo/logo_ngser.png" style="width: 100%; height:42%; max-width: 160px;margin-left: 11px; margin-bottom: 8%; border-radius: 3px;">
            </td>
            <td>
...
<div id='container'>
    <div class="ui-layout-west">
        <div id='leftPanel'>
            <div id='arborescence' class="ui-layout-center" style="height: 90vh;background-color: transparent;border-radius: 2px;border: 2px solid red;">
                <div class="text-center text-info" style="margin-top: 10%;font-family: 'Times New Roman'">Date: 18/12/202</div> <!-- Nom de l'entreprise -->
                ...
                <section>
                    ...
                    <ul class="nav-list" id="nav-listAdmins" style="display:none; margin-top: -2%;">
                       <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span style="font-size: 12px; font-family: 'Times New Roman'">ADMINISTRATION 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">ADMINISTRATION 2</span>
                            </span>
                            <ul class="nav-link" id="nav-linkAdmins2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration deuxieme partie 6</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3%">
                            <span style="">
                                <span class="hamburger-menu">
                                 ...
                                 <span class="h6">ADMINISTRATION 3</span>
                            </span>
                            <ul class="nav-link" id="nav-linkAdmins3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Administration troisieme partie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <main class="btn btnRcrs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">RESSOURCES HUMAINES</span>
                    </main>
                    <ul class="nav-list" id="nav-listRcrs" style="display:none; margin-top: -2%;">
                       <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">GESTION DES EMPLOYES</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs1" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="javascript:void(0)" onClick="javascript:affichePage('lien_param','/NGSYSTEST/interface/session/principal/sidebarmenu/creation_dmdabsence.php')">Demande d'absence</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="/NGSYSTEST/interface/session/principal/sidebarmenu/creation_dmdabsence.php">Demande d'attestation</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                               <span class="hamburger-menu">
                                 ...
                                 <span class="h6">GESTIONS DES CONGES</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Conges 6</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3%">
                            <span style="">
                                <span class="hamburger-menu">
                                 ...
                                 <span class="h6">GESTIONS DE LA PAIE</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">paie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <!-- FINANCE & COMPTABILITE -->
                     <main class="btn btnFncs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">FINANCE & COMPTABILITE</span>
                    </main>
                    <ul class="nav-list" id="nav-listFncs" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">FINANCE & COMPTABILITE 1</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs1" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace premiere partie 6</a>
                                </li>
                            </ul>
                        </li>
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">FINANCE & COMPTABILITE 2</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace deuxieme partie 6</a>
                                </li>
                            </ul>
                        </li>
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">FINANCE & COMPTABILITE 3</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 13px;color: rgb(42, 138, 247);" href="#">Finanace troisieme partie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <main class="btn btnMarks" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">MARKETING</span>
                    </main>
                    <ul class="nav-list" id="nav-listMarks" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">MARKETING 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">MARKETING 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">MARKETING 3</span>
                            </span>
                    ...
                    <main class="btn btnComls" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">COMMERCIAL</span>
                    </main>
                    <ul class="nav-list" id="nav-listComls" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">COMMERCES 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                               <span class="hamburger-menu">
                                ...
                                <span class="h6">COMMERCES 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">COMMERCES 3</span>
                            </span>
                    ...
                    <main class="btn btnGests" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">GESTION DE PROJETS</span>
                    </main>
                    <ul class="nav-list" id="nav-listGests" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">GESTIONS DE PROJETS 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">GESTION DE PROJETS 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">GESTION DE PROJET 3</span>
                            </span>
                    ...
                    <main class="btn btnInfors" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">TECHNIQUE INFORMATIQUE</span>
                    </main>
                    <ul class="nav-list" id="nav-listInfors" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE INFORMATIQUE 1</span>
                            </span>
                         ...
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE INFORMATIQUE 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE INFORMATIQUE 3</span>
                            </span>
                    ...
                    <main class="btn btnTelecs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;">
                        ...
                        <span class="h5" style="color: #FFF;font-weight: 1;">TECHNIQUE TELECOM</span>
                    </main>
                     <ul class="nav-list" id="nav-listTelecs" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE TELECOM 1</span>
                            </span>
                         ...
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE TELECOM 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="h6">TECHNIQUE TELECOM 3</span>
                            </span>
       ...
       <!-- <iframe src='' allowTransparency="false" style='height: 80%;width: 100%;margin-left:10px;' frameborder='1' id='ifr_centerbal' name='centerbal'></iframe>-->
    ...
    <div id='container_onglet' class="ui-layout-center">
        <div role="main" id='div_center' class="divs_center yui-navset"> 
            <ul class="yui-nav">  
                <li class="selected"><a href="#tab_centerbal"  id='yui-nav-accueil'><em><i class="fa fa-home fa-1x"></i>{PAGE_ACCUEIL}</em></a></li>  
            </ul>
                        
            <div class="yui-content" id="nav-content">  

                <div id="tab_centerbal"  style="height: 89vh; margin-top: 0%;background: linear-gradient(rgba(16, 29, 44, .0),rgba(16, 29, 44, .45)),url(../../../../images/icons/prog.jpg); background-repeat: no-repeat;background-size:cover;">  
