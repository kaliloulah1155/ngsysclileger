...
PosLayout.prototype.basculerEcran = function(szEcran)  {
    ...
    if (szEcran == 'centerbal') {
        ...
        document.getElementById('ifr_centerbal').style.display = "none"; //modifier par ibrahim
...
<!-- debut du navbar-entete -->
<div class="container-fluid">
	<div style="width: 100%;height: 8vh;background: #4a67b3;border-radius: 5px">
		<nav>
			<span class="navbar-brand">
				<img src="../../../../images/logo/ngser.png" style="width: 100%; max-width: 160px;margin-left: -1px; margin-top: -9%; border-radius: 3px;">
			</span>
			<ul class="nav-list1 text-center p-0">
				<li class="nav-item1">
					<a class="nav-link1 text-white" href="#"> 
						<!-- <nav class="menu" id="contenu-menu">{CONTENU_MENU}</nav> -->
						<i class="fa fa-cogs fa-1x"></i> 
						<span>OUTILS</span>
					</a>
					<ul style="display: block;position: rerlative; z-index: 999;">
			...
			<!-- -->
				<li class="nav-item1">
					<a class="nav-link1 text-white" href>
						<i class="fa fa-search fa-1x" style="font-size: 15px;"></i>
						<span>RECHERCHE</span>
					</a>
				</li>
			<!-- -->
				<li class="nav-item" style="margin-top: -17px;">
					<i class="fa fa-user fa-1x" style="color: #fff;font-size: 15px;"></i><br>
					<span id='libelle_profil' style="color: #fff;font-size: 14px;font-family: 'Times New Roman'; margin-bottom: 15%">{PROFIL_UTILISATEUR}</span> 
				</li>
			<!-- -->
				<li class="nav-item">
					<a class="text-white" href="javascript:void(0);" onClick="javascript:onCloseApplication();return false;" title="{LIBELLE_TOOLBAR_FERMER}">
						<img class="img-fluid" src="../../../../images/toolbar/deco1.png" alt="{LIBELLE_TOOLBAR_FERMER}" width="30" style="margin-left: 25%; margin-top: -13px;">
					</a>
				</li>
			</ul>
		</nav>
...
<!-- arborescence -->
<!-- fin du navbar-entete -->
	
<div id='container'>
    <div class="ui-layout-west" style="background: rgb(221, 218, 220);border: none;font-family: 'Times New Roman'">
        <div id='leftPanel'>
            <div id='arborescence' class="ui-layout-center" style="height: 80vh;background-color: transparent;border-radius: 2px;border: 2px solid blue;margin-top: 7%;">
                ...
                <hr style="width:35%; margin-top: 3%; border: 1px solid blue; margin-buttom: 15%"> <!-- Barre en blanc -->
				
				<!-- Debut sidemenubar -->
                <section>
                     <!-- ADMINISTRATION -->
                    <main class="btn btnAdmins" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleAdmins"></i>
                            <i class="fa fa-folder-open toggleAdmins"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">ADMINISTRATION</span>
                    </main>
                    <ul class="nav-list" id="nav-listAdmins" style="display:none; margin-top: -2%;">
                       <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleAdmins1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">ADMINISTRATION 1</span>
                            </span>
                            <ul class="nav-link" id="nav-linkAdmins1" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration premiere partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration premiere partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration premiere partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleAdmins2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">ADMINISTRATION 2</span>
                            </span>
                            <ul class="nav-link" id="nav-linkAdmins2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 2eme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 2eme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 2eme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 2eme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 2eme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Administration 2eme partie 6</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3%">
                            <span style="">
                                <span class="hamburger-menu">
                                 ...
                                 <span class="toggleAdmins3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">ADMINISTRATION 3</span>
                            </span>
                            <ul class="nav-link" id="nav-linkAdmins3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 3eme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 3eme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 3eme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 3eme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Administration 3eme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Administration 3eme partie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <!-- RESSOURCES HUMAINES -->
                    <main class="btn btnRcrs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleRcrs"></i>
                            <i class="fa fa-folder-open toggleRcrs"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">RESSOURCES HUMAINES</span>
                    </main>
                    <ul class="nav-list" id="nav-listRcrs" style="display:none; margin-top: -2%;">
                       <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleRcrs1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTION DES EMPLOYES</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs1" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman"  onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=ABS');" title="">Demande d'absence</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=ATT');">Demande d'attestation</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=PRT');">Demande de pret</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Domiciliation bancaire</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Enregistrement justificatifs</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Timesheet</a>
                                </li>
                            </ul>
                        </li>  
                        <li style="padding-top: 3% ; display: none" class="btnRcrs2">
                            <span style="color: rgb(0, 2, 5)">
                               <span class="hamburger-menu">
                                   <i class="fa fa-bars toggleRcrs2"></i>
                                    <i class="fa fa-times toggleRcrs2"></i>
                                </span>
                                 <span class="toggleRcrs2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTIONS DES CONGES</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">Conges 6</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3% ;display: none" class="btnRcrs3">
                            <span style="">
                                <span class="hamburger-menu">
                                   <i class="fa fa-bars toggleRcrs3"></i>
                                    <i class="fa fa-times toggleRcrs3"></i>
                                </span>
                                 <span class="toggleRcrs3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTIONS DE LA PAIE</span>
                            </span>
                            <ul class="nav-link" id="nav-linkRcrs3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman'" href="#">paie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <!-- FINANCE & COMPTABILITE -->
                     <main class="btn btnFncs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleFncs"></i>
                            <i class="fa fa-folder-open toggleFncs"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE</span>
                    </main>
                    <ul class="nav-list" id="nav-listFncs" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleFncs1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 1</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs1" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace premiere partie 6</a>
                                </li>
                            </ul>
                        </li>
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleFncs2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 2</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs2" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace deuxieme partie 6</a>
                                </li>
                            </ul>
                        </li>
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleFncs3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 3</span>
                            </span>
                            <ul class="nav-link" id="nav-linkFncs3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace troisieme partie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace troisieme partie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman" href="#">Finanace troisieme partie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                    ...
                    <!-- MARKETING  -->
                    <main class="btn btnMarks" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleMarks"></i>
                            <i class="fa fa-folder-open toggleMarks"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">MARKETING</span>
                    </main>
                    <ul class="nav-list" id="nav-listMarks" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleMarks1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">MARKETING 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleMarks2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">MARKETING 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleMarks3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">MARKETING 3</span>
                            </span>
                    ...
                    <!-- COMMERCIAL -->
                    <main class="btn btnComls" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleComls"></i>
                            <i class="fa fa-folder-open toggleComls"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">COMMERCIAL</span>
                    </main>
                    <ul class="nav-list" id="nav-listComls" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleComls1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">COMMERCES 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                               <span class="hamburger-menu">
                                ...
                                <span class="toggleComls2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">COMMERCES 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleComls3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">COMMERCES 3</span>
                            </span>
                    ...
                    <!-- GESTION DE PROJETS -->
                    <main class="btn btnGests" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleGests"></i>
                            <i class="fa fa-folder-open toggleGests"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">GESTION DE PROJETS</span>
                    </main>
                    <ul class="nav-list" id="nav-listGests" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleGests1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTIONS DE PROJETS 1</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleGests2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTION DE PROJETS 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleGests3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">GESTION DE PROJET 3</span>
                            </span>
                    ...
                    <main class="btn btnInfors" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleInfors"></i>
                            <i class="fa fa-folder-open toggleInfors"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE</span>
                    </main>
                    <ul class="nav-list" id="nav-listInfors" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleInfors1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 1</span>
                            </span>
                         ...
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleInfors2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleInfors3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 3</span>
                            </span>
                    ...
                    <!-- TECHNIQUE TELECOM -->
                    <main class="btn btnTelecs" style="width: 100%;height: 6vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px; display: none">
                        <span class="hamburgerIcon">
                            <i class="fa fa-folder toggleTelecs"></i>
                            <i class="fa fa-folder-open toggleTelecs"></i>
                        </span>
                        <span class="" style="color: #FFF;font-weight: 1;font-size: 14px; font-family: 'Times New Roman'">TECHNIQUE TELECOM</span>
                    </main>
                     <ul class="nav-list" id="nav-listTelecs" style="display:none; margin-top: -2%;">
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleTelecs1" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE TELECOM 1</span>
                            </span>
                         ...
                         <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleTelecs2" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE TELECOM 2</span>
                            </span>
                        ...
                        <li style="padding-top: 3%">
                            <span style="color: rgb(0, 2, 5)">
                                ...
                                <span class="toggleTelecs3" style="cursor: pointer; font-size: 12px; font-family: 'Times New Roman'">TECHNIQUE TELECOM 3</span>
                            </span>
				...
				<!-- Fin sidemenubar -->
            <div>
            <div id="treeDiv1" style="display: none"></div> <!--modifier par ibrahim -->
        </div>
        ...
        <iframe src='' allowTransparency="false" style='height: 80%;width: 100%;margin-left:10px;display:none;' frameborder='1' id='ifr_centerbal' name='centerbal'></iframe> <!--15/01/2021-->	
    ...
    <div id='container_onglet' class="ui-layout-center" style="background: rgb(221, 218, 220); font-family: 'Times New Roman'">
       <!-- <h1 style="color: rgb(11, 11,99); font-size: 21px; font-weight: 1">Bienvenue dans votre espace ERP NGSYSTEST</h1>
                ...
                <li class="selected">
					<a href="#tab_centerbal"  id='yui-nav-accueil'>
						<em>
							...
							<span style="font-size: 10px;font-family: 'Times New Roman'">{PAGE_ACCUEIL}</span>
						</em>
					</a>
				</li>  
            </ul>
                        
            <div class="yui-content" id="nav-content" style="height: 80vh;background: rgb(221, 218, 218);">  
                <div id="tab_centerbal"  style="height: 78vh; margin-top: 0%;background: linear-gradient(rgba(16, 29, 44, .0),rgba(16, 29, 44, .45)),url(../../../../images/menu/imageNgser.png); background-repeat: no-repeat;background-size:cover;">  
