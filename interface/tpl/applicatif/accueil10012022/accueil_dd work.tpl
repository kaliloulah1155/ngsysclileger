...
var msgTipAfficherPanneauLateral = "Afficher le panneau latéral";
var msgTipMasquerPanneauLateral = "Masquer le panneau latéral";
    ...
    <tr style='vertical-align: middle;'>
       ...
       <td style="text-align: right;">
            <span class="libellemenu">
                <a class="libellemenu" href="#" OnClick="javascript:window.open('/{NOM_APPLICATION}/Aide/aide.htm','','resizable=yes,directories=no,location=no,width=1000, height=800')" title="Accèder à l'aide en ligne">
