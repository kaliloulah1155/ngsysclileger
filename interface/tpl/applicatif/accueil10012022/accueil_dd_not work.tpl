...
<!-- <link href='/{NOM_APPLICATION}/include/style/tableau_de_bord/style.css' type='text/css' rel='STYLESHEET'/>
<link href='/{NOM_APPLICATION}/include/style/tableau_de_bord/owl.css' type='text/css' rel='STYLESHEET'/>
<link href='/{NOM_APPLICATION}/include/style/tableau_de_bord/mdb.css' type='text/css' rel='STYLESHEET'/> -->
...
<body class='accueil yui-skin-sam' onLoad="initEcran();" onResize="testpositionnement();" onBeforeUnLoad='onUnload();'>
	...
	<style>
        ...
        #hamburger-menu_a1>.fa-minus{
            display: none;
        }

        #hamburger-menu_a1>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_a1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_a2>.fa-minus{
            display: none;
        }

        #hamburger-menu_a2>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_a2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_a3>.fa-minus{
            display: none;
        }

        #hamburger-menu_a3>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_a3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_r1>.fa-minus{
            display: none;
        }

        #hamburger-menu_r1>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_r1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_r2>.fa-minus{
            display: none;
        }

        #hamburger-menu_r2>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_r2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_r3>.fa-minus{
            display: none;
        }

        #hamburger-menu_r3>.fa-minus.open{
            display: block;
        }

        #hamburger-menu_r3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_cf1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_cf1>.fa-minus{
            display: none;
        }

        #hamburger-menu_cf1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_cf2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_cf2>.fa-minus{
            display: none;
        }

        #hamburger-menu_cf2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_cf3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_cf3>.fa-minus{
            display: none;
        }

        #hamburger-menu_cf3>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_m1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_m1>.fa-minus{
            display: none;
        }

        #hamburger-menu_m1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_m2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_m2>.fa-minus{
            display: none;
        }

        #hamburger-menu_m2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_m3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_m3>.fa-minus{
            display: none;
        }

        #hamburger-menu_m3>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_c1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_c1>.fa-minus{
            display: none;
        }

        #hamburger-menu_c1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_c2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_c2>.fa-minus{
            display: none;
        }

        #hamburger-menu_c2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_c3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_c3>.fa-minus{
            display: none;
        }

        #hamburger-menu_c3>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_p1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_p1>.fa-minus{
            display: none;
        }

        #hamburger-menu_p1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_p2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_p2>.fa-minus{
            display: none;
        }

        #hamburger-menu_p2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_p3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_p3>.fa-minus{
            display: none;
        }

        #hamburger-menu_p3>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_i1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_i1>.fa-minus{
            display: none;
        }

        #hamburger-menu_i1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_i2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_i2>.fa-minus{
            display: none;
        }

        #hamburger-menu_i2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_i3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_i3>.fa-minus{
            display: none;
        }

        #hamburger-menu_i3>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_t1>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_t1>.fa-minus{
            display: none;
        }

        #hamburger-menu_t1>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_t2>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_t2>.fa-minus{
            display: none;
        }

        #hamburger-menu_t2>.fa-minus.open{
            display: block;
        }
        ...
        #hamburger-menu_t3>.fa-plus.open{
            display: none;
        }

        #hamburger-menu_t3>.fa-minus{
            display: none;
        }

        #hamburger-menu_t3>.fa-minus.open{
            display: block;
        }
    	...
    	<div style="width: 100%;padding:25px;background: #4a67b3;border-radius: 5px">
    		<nav>
    			<span class="navbar-brand">
    				<img src="../../../../images/logo/ngser.png" style="width: 100%; max-width: 150px;height: 7vh; margin: -37px -25px;  border-radius: 1px;">
    			</span>

                 <div class="hamburger_menu" title="menu">
...
<div id='container'>
    ...
    <div class="ui-layout-west" style="background: rgb(221, 218, 220);border: none;">
        <div id='leftPanel' style="display: none;"></div>
            
        <div id='arborescence' class="ui-layout-center" style="background-color: transparent;border-radius: 2px;border: 2px solid #4a67b3;margin-top: 7%;padding-left: 5%;padding-right: 5%;max-width: 250px;min-width: 250px">
            ...
            <section class="active">
                <a class="btn" style="width: 100%; height: 5vh;text-align: center; padding: 6%;border-radius: 5px;line-height: 5px;font-weight:lighter;background: #4a67b3;margin-bottom: 15px;" href="javascript:void(0);" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=TBD');">
                    <!-- <i class="fa fa-archive fa-1x" style="color: #fff;font-size: 12px; float: left;"></i>   -->
                    <span class="" style="color: #FFF;font-weight: 1;font-size: 0.8vw; font-family: 'Times New Roman'">CORBEILLE DES TACHES</span>
                </a>
                 <!-- ADMINISTRATION -->
                ...
                <ul class="nav-list" id="nav-listAdmins" style="display:none;margin-top: -11px;">
                   <li style="padding-top: 3%;padding-right: -2%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_a1">
                                <i class="fas fa-plus toggle_1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_1" id="moin_A1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleAdmins1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DES FOURNISSEURS</span>
                        </span>
                        <ul class="nav-link" id="nav-linkAdmins1" style="display: none; margin-left:-6%;">
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0);" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=FOU');">Creation fournisseur</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0);" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=PRO');">Creation de pro-forma</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration premiere partie 3</a>
                            </li>
                        </ul>
                    </li>
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_a2">
                                <i class="fas fa-plus toggle_2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_2" id="moin_A2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleAdmins2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">ADMINISTRATION 2</span>
                        </span>
                        <ul class="nav-link" id="nav-linkAdmins2" style="display: none; margin-left:-6%">
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 2eme partie 1</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 2eme partie 2</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 2eme partie 3</a>
                            </li>
                        </ul>
                    </li>
                    <li style="padding-top: 3%">
                        <span style="">
                            <span class="hamburger-menu" id="hamburger-menu_a3">
                                <i class="fas fa-plus toggle_3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_3" id="moin_A3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                             <span class="toggleAdmins3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">ADMINISTRATION 3</span>
                        </span>
                        <ul class="nav-link" id="nav-linkAdmins3" style="display: none; margin-left:-6%">
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 3eme partie 1</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 3eme partie 2</a>
                            </li>
                            <li style="margin: 1% -15%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Administration 3eme partie 3</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="nav-list" id="nav-listRcrs" style="display:none;margin-top: -11px;">
                   <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_r1">
                                <i class="fas fa-plus toggle_r1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_r1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleRcrs1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DES EMPLOYES</span>
                        </span>
                        <ul class="nav-link" id="nav-linkRcrs1" style="display: none; margin-left: -6%;">
                           
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0);" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=CAS');">Consommation assur&#233;e</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=COT');">Contrat</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=DFM');">Demande de formation</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;" class="fiche_identification">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=PRS');">Fiche d&#146;identification</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=FPO');">Fiche de poste</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=LIC');">Licenciement </a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=POS');">Poste</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=SAN');">Sanction</a>
                            </li>
                        </ul>
                    </li>  
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                           <span class="hamburger-menu" id="hamburger-menu_r2">
                                <i class="fas fa-plus toggle_r2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_r2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                             <span class="toggleRcrs2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTIONS DES HORAIRES</span>
                        </span>
                        <ul class="nav-link" id="nav-linkRcrs2" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0);" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=ABS');">Absence</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=DEM');">D&#233;mission</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=JUS');">Enregistrement justificatifs</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=HSU');">Heures supplementaires</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=MIS');">Mission</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=TMS');">Timesheet</a>
                            </li>
                             <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=REG');">Registre employeur</a>
                            </li>
                        </ul>
                    </li>
                    <li style="padding-top: 3%">
                        <span style="">
                            <span class="hamburger-menu" id="hamburger-menu_r3">
                                <i class="fas fa-plus toggle_r3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_r3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                             <span class="toggleRcrs3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTIONS DE LA PAIE</span>
                        </span>
                        <ul class="nav-link" id="nav-linkRcrs3" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=PRT');">Demande de pret</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=DBQ');">Domiciliation bancaire</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=PAY');">Fiche de paie</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_cf1">
                                <i class="fas fa-plus toggle_cf1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_cf1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleFncs1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 1</span>
                        </span>
                        <ul class="nav-link" id="nav-linkFncs1" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=DED');">Engagement de d&eacute;pense</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 2</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 3</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 4</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 5</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 6</a>
                            </li>
                        </ul>
                    </li>
                     <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_cf2">
                                <i class="fas fa-plus toggle_cf2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_cf2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleFncs2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 2</span>
                        </span>
                        <ul class="nav-link" id="nav-linkFncs2" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 1</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 2</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 3</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 4</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 5</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace deuxieme partie 6</a>
                            </li>
                        </ul>
                    </li>
                     <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_cf3">
                                <i class="fas fa-plus toggle_cf3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_cf3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleFncs3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">FINANCE & COMPTABILITE 3</span>
                        </span>
                        <ul class="nav-link" id="nav-linkFncs3" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 1</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 2</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                            ...
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 5</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 6</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_m1">
                                <i class="fas fa-plus toggle_m1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_m1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleMarks1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">MARKETING 1</span>
                        </span>
                        <ul class="nav-link" id="nav-linkMarks1" style="display: none; margin-left: -6%">
                            ...
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 3</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 4</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace troisieme partie 5</a>
                            </li>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_m2">
                                <i class="fas fa-plus toggle_m2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_m2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleMarks2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">MARKETING 2</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_m3">
                                <i class="fas fa-plus toggle_m3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_m3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleMarks3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">MARKETING 3</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_c1">
                                <i class="fas fa-plus toggle_c1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_c1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleComls1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DES CLIENTS</span>
                        </span>
                        <ul class="nav-link" id="nav-linkComls1" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=CLT');">Cr&eacute;ation clients</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="javascript:void(0)">Gestion des client 2</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Gestion des client 2</a>
                            </li>
                        </ul>
                    </li>
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_c2">
                                <i class="fas fa-plus toggle_c2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_c2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleComls2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DES VENTES</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_c3">
                                <i class="fas fa-plus toggle_c3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_c3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleComls3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DES PRODUITS</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_p1">
                                <i class="fas fa-plus toggle_p1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_p1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleGests1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTIONS DE PROJETS 1</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_p2">
                                <i class="fas fa-plus toggle_p2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_p2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleGests2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DE PROJETS 2</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_p3">
                                <i class="fas fa-plus toggle_p3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_p3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleGests3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">GESTION DE PROJET 3</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_i1">
                                <i class="fas fa-plus toggle_i1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_i1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleInfors1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 1</span>
                        </span>
                        <ul class="nav-link" id="nav-linkInfors1" style="display: none; margin-left: -6%">
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 1</a>
                            </li>
                            <li style="margin: 1% -13%;font-weigth: lighter;">
                                <a style="font-size: 13px;color: rgb(42, 138, 247);font-family: Times New Roman;color: #4a67b3;" href="#">Finanace premiere partie 2</a>
                            </li>
                     ...
                     <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_i2">
                                <i class="fas fa-plus toggle_i2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_i2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleInfors2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 2</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_i3">
                                <i class="fas fa-plus toggle_i3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_i3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleInfors3" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">TECHNIQUE INFORMATIQUE 3</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_t1">
                                <i class="fas fa-plus toggle_t1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_t1" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleTelecs1" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">TECHNIQUE TELECOM 1</span>
                        </span>
                     ...
                     <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_t2">
                                <i class="fas fa-plus toggle_t2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_t2" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
                            <span class="toggleTelecs2" style="cursor: pointer; font-size: 10px; font-family: 'Times New Roman'">TECHNIQUE TELECOM 2</span>
                        </span>
                    ...
                    <li style="padding-top: 3%">
                        <span style="color: rgb(0, 2, 5)">
                            <span class="hamburger-menu" id="hamburger-menu_t3">
                                <i class="fas fa-plus toggle_t3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);"></i>
                                <i class="fas fa-minus toggle_t3" style="font-size: 10px;color: rgba(87, 81, 81, 0.3);margin-top: 5px;"></i>
                            </span>
        ...
        <div role="main" id='div_center' style="background-color: transparent;border: none;top: 0px;" class="divs_center yui-navset"> 
            <ul class="yui-nav">  
                <li class="selected">
                  ...
                  <!-- style="margin-top: 0%;background: linear-gradient(rgba(16, 29, 44, .0),rgba(16, 29, 44, .45)),url(../../../../images/menu/imageNgser.png); background-repeat: no-repeat;background-size:cover;background-position: center" --> 
...
<script type="text/javascript">
        ...
        $('.toggleAdmins1,.toggleRcrs1').on('click', function(){
            $('.toggle_1').toggleClass('open');
        });
        $('.toggleAdmins2').on('click', function(){
            $('.toggle_2').toggleClass('open');
        });
        $('.toggleAdmins3').on('click', function(){
            $('.toggle_3').toggleClass('open');
        });

        // RH
        $('.toggleRcrs1').on('click', function(){
            $('.toggle_r1').toggleClass('open');
        });
        $('.toggleRcrs2').on('click', function(){
            $('.toggle_r2').toggleClass('open');
        });

        $('.toggleRcrs3').on('click', function(){
            $('.toggle_r3').toggleClass('open');
        });

        // FC
        $('.toggleFncs1').on('click', function(){
            $('.toggle_cf1').toggleClass('open');
        });
        $('.toggleFncs2').on('click', function(){
            $('.toggle_cf2').toggleClass('open');
        });

        $('.toggleFncs3').on('click', function(){
            $('.toggle_cf3').toggleClass('open');
        });

        $('.toggleMarks1').on('click', function(){
            $('.toggle_m1').toggleClass('open');
        });

        $('.toggleMarks2').on('click', function(){
            $('.toggle_m2').toggleClass('open');
        });

        $('.toggleMarks3').on('click', function(){
            $('.toggle_m3').toggleClass('open');
        });


        $('.toggleComls1').on('click', function(){
            $('.toggle_c1').toggleClass('open');
        });

        $('.toggleComls2').on('click', function(){
            $('.toggle_c2').toggleClass('open');
        });
        
        $('.toggleComls3').on('click', function(){
            $('.toggle_c3').toggleClass('open');
        });


        $('.toggleGests1').on('click', function(){
            $('.toggle_p1').toggleClass('open');
        });

        $('.toggleGests2').on('click', function(){
            $('.toggle_p2').toggleClass('open');
        });

        $('.toggleGests3').on('click', function(){
            $('.toggle_p3').toggleClass('open');
        });


        $('.toggleInfors1').on('click', function(){
            $('.toggle_i1').toggleClass('open');
        });

        $('.toggleInfors2').on('click', function(){
            $('.toggle_i2').toggleClass('open');
        });

        $('.toggleInfors3').on('click', function(){
            $('.toggle_i3').toggleClass('open');
        });


        $('.toggleTelecs1').on('click', function(){
            $('.toggle_t1').toggleClass('open');
        });

        $('.toggleTelecs2').on('click', function(){
            $('.toggle_t2').toggleClass('open');
        });

        $('.toggleTelecs3').on('click', function(){
            $('.toggle_t3').toggleClass('open');
        });


        //debut affichage des sidebar en fonction du profil connecté        
        $('.fiche_identification').hide();
        ...
        case "TELECOM":
          ...
          default:
            ...
            //fin affichage des sidebar en fonction du profil connecté  
