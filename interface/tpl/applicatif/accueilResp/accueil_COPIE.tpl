	...
	<div style="width: 100%;height: 8vh;background: #4a67b3;border-radius: 5px">
		<nav>
			<span class="navbar-brand">
				<img src="../../../../images/logo/ngser.png" style="width: 100%; max-width: 160px; height: 7vh; margin-left: -1px; margin-top: -7.5%; border-radius: 1px;">
			</span>
...
<div id='container'>
    <div class="ui-layout-west" style="background: rgb(221, 218, 220);border: none;font-family: 'Times New Roman'">
        <div id='leftPanel'>
            <div id='arborescence' class="ui-layout-center" style="height: 80vh;background-color: transparent;border-radius: 2px;border: 2px solid #4a67b3;margin-top: 7%;">
                       ...
                       <li style="padding-top: 3%">
                        ...
                        <li style="padding-top: 3%">
                            ...
                            <ul class="nav-link" id="nav-linkRcrs2" style="display: none; left: 0;">
                                ...
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">Conges 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">Conges 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">Conges 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">Conges 6</a>
                                </li>
                            </ul>
                        </li>
                        <li style="padding-top: 3%">
                            ...
                            <ul class="nav-link" id="nav-linkRcrs3" style="display: none; left: 0;">
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 1</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 2</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 3</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 4</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 5</a>
                                </li>
                                <li style="margin: 1% -13%;font-weigth: lighter;">
                                    <a style="font-size: 15px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="#">paie 6</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
       ...
       <!-- <h1 style="color: rgb(11, 11,99); font-size: 21px; font-weight: 1">Bienvenue dans votre espace ERP NGSYSTEST</h1>
        ...
        <div role="main" id='div_center' style="background-color: transparent;border: none;top: 0px;" class="divs_center yui-navset"> 
            ...
            <div class="yui-content" id="nav-content" style="height: 78vh;background: rgb(221, 218, 218);">  
                <div id="tab_centerbal"  style="height: 76vh; margin-top: 0%;background: linear-gradient(rgba(16, 29, 44, .0),rgba(16, 29, 44, .45)),url(../../../../images/menu/imageNgser.png); background-repeat: no-repeat;background-size:cover;">  
