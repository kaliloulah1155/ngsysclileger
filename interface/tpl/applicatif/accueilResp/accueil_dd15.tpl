...
<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/assets/assets/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/assets/assets/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/assets/assets/css/dataTables.bootstrap4.min.css">
<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/assets/assets/css/select2.min.css">
<link rel="stylesheet" type="text/css" href="/{NOM_APPLICATION}/include/assets/assets/css/style.css">
...
<div id='container' style="display: none;">
    ...
    <div id='container_onglet' class="ui-layout-center" style="background: rgb(221, 218, 220); font-family: 'Times New Roman'">
        ...
        <div role="main" id='div_center' style="background-color: transparent;border: none;top: 0px;" class="divs_center yui-navset"> 
            ...
            <div class="yui-content" id="nav-content" style="height: 90vh;background: rgb(221, 218, 218);">  
...
<div class="main-wrapper">
    ...
    <div class="header">
        <div class="header-left">
            <a href="index.html" class="logo">
                <img src="/{NOM_APPLICATION}/include/assets/assets/img/ngser.jpg" width="130" height="42" alt="" style="border-radius: 1px;">
            </a>
        </div>
        ...
        <ul class="nav user-menu float-right">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                    <span class="user-img">
                        <img class="rounded-circle" src="/{NOM_APPLICATION}/include/assets/assets/img/user.jpg" width="40" alt="Admin">
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="active">
                        <a class="active" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/question/afficher_question.php'"><i class="fa fa-dashboard"></i><span>TABLEAU DE BORD</span></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=MIS');"><i class="fa fa-exchange" aria-hidden="true"></i><span>Currency Exchange</span></a>
                    </li>
                    <li class="submenu">
                        <a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span> Buy & Sell </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="buy-crypto.html">Buy Crypto</a></li>
                            <li><a href="sell-crypto.html">Sell Crypto</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="trading.html"><i class="fa fa-line-chart" aria-hidden="true"></i> <span>Trading</span></a>
                    </li>
                    <li>
                        <a href="market.html"><i class="fa fa-rocket" aria-hidden="true"></i> <span>Marketcap</span></a>
                    </li>
                    <li>
                        <a href="transactions.html"><i class="fa fa-retweet" aria-hidden="true"></i> <span>Transactions</span></a>
                    </li>
                     <li>
                        <a href="wallet.html"><i class="fa fa-briefcase" aria-hidden="true"></i> <span>Wallet</span></a>
                    </li>
                    <li class="submenu">
                    ...
                    <li class="submenu">
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fa fa-area-chart" aria-hidden="true"></i><span> Charts</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
    ...
    <!-- Content -->
    <div class="page-wrapper bg-wrapper ui-layout-west">
...
<script src="/{NOM_APPLICATION}/include/assets/assets/js/jquery-3.2.1.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/popper.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/bootstrap.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/jquery.dataTables.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/dataTables.bootstrap4.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/amchart.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/serial.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/light.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/amstock.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/pie.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/plugins/amchart/js/responsive.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/select2.min.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/jquery.slimscroll.js"></script>
<script src="/{NOM_APPLICATION}/include/assets/assets/js/app.js"></script>
