...
<body class='accueil yui-skin-sam' onLoad="initEcran();" onResize="testpositionnement();" onBeforeUnLoad='onUnload();' style="background: #fff">
...
<div id='container'>
            ...
            <section class="active">
                ...
                <ul class="nav-list" id="nav-listAdmins" style="display:none;margin-top: -11px;">
                   <li style="padding-top: 3%;padding-right: -2%">
                        ...
                        <ul class="nav-link" id="nav-linkAdmins1" style="display: none; margin-left:-7%;">
                    ...
                    <li style="padding-top: 3%">
                        ...
                        <ul class="nav-link" id="nav-linkRcrs2" style="display: none; margin-left: -6%">
                            ...
                            <li style="margin: 1% -13%;font-weigth: lighter;" id="jus">
                                <a style="font-size: 14px;color: rgb(42, 138, 247);font-family: 'Times New Roman';color: #4a67b3;" href="javascript:void(0)" onClick="javascript:return affichePageToolbar(this, 'lien_1','/{NOM_APPLICATION}/interface/session/principal/creation/afficher_creation.php?POS_TYPEDOC=JUS');">Mes justificatifs d&#146;absence</a>
                            </li>
    ...
    <!-- SECTION RIGTH -->
    <div id='container_onglet' class="ui-layout-center" style="background: #fff; font-family: 'Times New Roman'"><!-- rgb(221, 218, 220) -->
        <div role="main" id='div_center' style="background-color: transparent;border: none;top: 0px;" class="divs_center yui-navset"> 
           ...
           <div class="yui-content" id="nav-content" style="height: 500px;background: #fff;">  <!-- rgb(221, 218, 218); -->
