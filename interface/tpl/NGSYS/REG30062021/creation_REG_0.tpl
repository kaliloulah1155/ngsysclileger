...
<body class='tpl_creation tpl_creation_reg' onLoad='initTplCreation();'style="background-color: transparent;font-family: 'Times New Roman';">
	<form name='principal' id="formpret" ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();' data-parsley-validate>
		...
		<div class="col_list">
			...
			<a href="javascript:void lanceBibBal('/{NOM_APPLICATION}/interface/session/principal/resultat/rechercher_db.php&TYPE_RECHERCHE=RECHERCHE_BAL&POS_QUEST_NOM=Bal_REG_Encours&POS_QUEST_PUBLIC=1', 'QUESTION_BAL');">
		...
		<nav class="container-fluid">
			<div class="col-sm-12 mt-5" style="margin-top: 3%;">
				...
				<div class="col2_partie">
					<div class="row" style="padding-top: 1%;padding-bottom: 2%">
						...
						<div class="col-sm-6 text-center" style="padding-top: 1%">
							<label>Cautionnement :</label><br>
							<input type="radio" class="btnFors" style="margin-right: 0.2%;margin-left: 0.3%">
							<span style="font-size: 12px;margin-right: 3%">Oui</span>
							<input type="radio" class="btnFors" checked style="margin-right: 0.2%">
							<span style="font-size: 12px;">Non</span>
						</div>
					</div>
					<div class="row" style="margin-top: 17px">
						<label style="font-size: 19px;font-weight: 500;margin-left: 17px">EN NATURE</label>
						<br>
						<div class="col-sm-3" style="padding-left: 5%; padding-bottom: 2%">
							<label>Nourriture :</label><br>
							<input type="radio" class="btnFors" style="margin-right: 0.2%;margin-left: 1%">
							<span style="font-size: 12px;margin-right: 3%">Oui</span>
							<input type="radio" class="btnFors" checked style="margin-right: 0.2%">
							<span style="font-size: 12px;">Non</span>
						</div>

						<div class="col-sm-3" style="padding-left: 9%; padding-bottom: 2%">
							<label>Logement :</label><br>
							<input type="radio" class="btnFors" name="POS_VAL_RUB_BUF" value="INITIATION" style="margin-left: 1%">
							<span style="font-size: 12px;margin-right: 3%">Oui</span>
							<input type="radio" class="btnFors" checked style="margin-right: 0.2%">
							<span style="font-size: 12px;">Non</span>
						</div>
			...
			<div class="row col_btn">
				...
				<input class="btn col-sm-2" value="ENREGISTRER" id="bouton" style="font-size: 12px;margin-left: 5%;">
			</div> 
		</nav>	
	</form>
