			...
			<table class="test" id="table_tache" style="width: 100%;text-align: center; margin-top: 2%;">
				<thead>
					<tr>
						...
						<td class="text-center" style="width: 150px;height: 7vh;border:none;background: #4a67b3;border-top-left-radius: 5px;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Date</span>
						</td>
						<td class="text-center" style="width: 100px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
						...
						<td class="text-center" style="width: 150px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span  style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Nombre heure r&#233;alis&#233;e</span>
						</td>
						<td class="text-center"style="width: 300px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Motifs</span>
						</td>
						<td class="text-center" style="width: 100px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px; border-top-right-radius: 5px;">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Montant</span>
						</td>
						<td class="text-center" style="width: 50px;height: 7vh;border:none;padding-top: 7px">
				...
				<tbody class="tableL">
					<tr>
						...
						<td style="width: 50px;border:none;">
							<input name="select[]" type="checkbox"  class="cbk"  style="width: 80%;font-size: 12px;margin-top: 19%;margin-left: -17%;" >
						</td>
					</tr>
				</tbody>
			</table>
		...
		$(".addRow").click(function(){
			...
			function  addRow(){ 
			  	var ligne ='<tr>'+
						...
						'</td>'+
						'<td style="width: 150px;border:none;">'+
								'<input type="text" name="date[]"   style="width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" placeholder="jj-mm-aaaa"  class="form-control date datepick">'+
						'</td>'+
						'<td style="width: 100px;border:none;">'+
