  ...
  while ($row = pg_fetch_row($rq)) {
    ...
    $output .="
          ...
          <td style='width: 150px;border:none;'>
            <input type='text'  name='date[]' value='".$date2."'   style='width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px' placeholder='jj-mm-aaaa' class='form-control date datepick' required='true'>
          </td>
          ...
          <td style='width: 50px;border:none;'>
            ...
            $output .=" class='cbk'  style='width: 100%;font-size: 12px;margin-left: -17%;margin-top: 19%' >
          </td>
  </tr>
  ";
