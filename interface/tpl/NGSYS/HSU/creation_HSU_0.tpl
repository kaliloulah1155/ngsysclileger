			...
			<table class="test" id="table_tache" style="width: 100%;text-align: center; margin-top: 2%;">
				<thead>
					<tr>
						...
						<td style="width: 150px;height: 7vh;border:none;background: #4a67b3;border-top-left-radius: 5px;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Date <span class='text'></span></span>
						</td>
						<td style="width: 100px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Heure d&#233;but <span class='text'></span></span>
						</td>
						<td style="width: 100px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Heure fin <span class='text'></span></span>
						</td>
						<td style="width: 150px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span  style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Nombre heure r&#233;alis&#233;e</span>
						</td>
						<td style="width: 300px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px">
							<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Motifs <span class='text'></span></span>
						</td>
						<td style="width: 100px;height: 7vh;border:none;background: #4a67b3;padding-top: 7px;border-top-right-radius: 5px;">
				...
				<tbody class="tableL">
					<tr>
						...
						<td style="width: 150px;border:none;">
							 <input type="text" name="date[]" style="width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" placeholder="jj-mm-aaaa" class="form-control date datepick" required="true">
						</td>
						...
						<td style="width: 150px;border:none;">
							<input type="text" readonly="true" name="duree[]"  style="width: 100%; height: 11vh;background: transparent;border: 1px solid;margin-top: 2px;" rows="2" placeholder="" class="form-control duree">
						</td>
						...
						<td style="width: 50px;border:none;">
							<input name="select[]" type="checkbox"  class="cbk"  style="width: 100%;font-size: 12px;margin-left: -37%;" >
						</td>
					</tr>
				</tbody>
			</table>
		...
		$(".addRow").click(function(){
			...
			function  addRow(){ 
			  	var ligne ='<tr>'+
						...
						'</td>'+
						'<td style="width: 150px;border:none;">'+
							'<input type="text" readonly="true" name="duree[]" style="width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" rows="2" class="form-control duree">'+
						'</td>'+
						'<td style="width: 300px;border:none;">'+
							'<textarea type="text" name="tache[]" style="width: 100%; resize: none;background: transparent;border: 1px solid;margin-top: 2px;resize: none;" rows="2" class="form-control tache" required="true"></textarea>'+
						'</td>'+
						'<td style="width: 100px;border:none;">'+
							'<input type="text" disabled name="montant[]" style="width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" rows="2" class="form-control montant">'+
						'</td>'+
						'<td style="width: 50px;border:none;">'+
							'<input name="select[]" class="cbk" type="checkbox" style="width: 100%;font-size: 12px;margin-left: -20%;" >'+
						'</td>'+
					'</tr>';
              	$('.tableL').append(ligne);
              	setDatePicker();
                ...
                function comparHeur(heurdbts,heurfns){
 				...
 				if(etat==false){
				   // console.log('pas coucou');
				    ...
				    $('.msg').show();
    				$('.msg').text("La d\u00e9claration d'une heure supplementaire se fait par journ\u00e9e jusqu'\u00e0 23h59.");
