...
<head>
  ...
  <title>Justificatif d&#146;absence</title>
...
<body class='tpl_creation tpl_creation_prt' onLoad='initTplCreation();'style="background-color: transparent;font-family: 'Times New Roman';">
	<form name='principal' id="formJUS" ACTION='{URL_ATTENTE}' class="cform" method='POST' onSubmit='return validerCreation();' data-parsley-validate>
		...
		<div class="col_list text-center px-3">
         ...
         <!--<a href="/{NOM_APPLICATION}/interface/tpl/{NOM_APPLICATION}/JUS/liste/liste_JUS_1.php?APPLI={NOM_APPLICATION}&USER={NOM_UTILISATEUR}&PROFIL={PROFIL_UTILISATEUR}">
					<span style="color:#4a67b3;">Cliquez pour consulter la liste</span>
				</a>
				-->
		</div>
			...
			<nav class="container-fluid" style="margin-top: 3%">
				...
				<div class="row">
					<div class="col-sm-12 text-center p-1" style="background: #4a67b3;color: #FFF;border-top-right-radius: 6px;border-top-left-radius: 6px;">
						<span class="title text-while">JUSTIFICATIF D&#146;ABSENCE </span>
					</div>
					...
					<div class="col-sm-12 pt-2" style="border: 1px solid #4a67b3">
						<div class="row">
							...
							<input type="hidden" name='POS_VAL_CTRL_AUN' id='POS_VAL_CTRL_AUN' required="true" data-parsley-trigger="keyup" value='{POS_VAL_RUB_AUN}'>
							</div>
							<div class="col-sm-6">
									<label for="bio">Date de d&eacute;part <span class='text'></span> :</label>
								<input type="text" class="form-control datedeb" placeholder="jj/mm/aaaa" name="POS_VAL_RUB_DT4"  id="d1" required="true" style="width: 100%;" data-parsley-trigger="keyup" value="{POS_VAL_RUB_DT4}">
							</div>
						</div>
						...
						<div class="row" style="margin-top: 2%">
							<div class="col-sm-6">
								...
								<textarea  name='POS_VAL_RUB_COM'class="form-control motif" id="motif" style="width: 100%;resize: none" rows="2" required="true" data-parsley-trigger="keyup"> {POS_VAL_RUB_COM}</textarea>
							</div>
							<div class="col-sm-6">
								<label for="bio">Heure de d&eacute;part <span class='text'></span> :</label>
								<input type="time" class="form-control timedeb" placeholder="Heure de d&eacute;part" name="POS_VAL_RUB_HRD" data-theme="a" data-clear-btn="true" id="t1" required="true" data-parsley-trigger="keyup" value="{POS_VAL_RUB_HRD}" style="width: 100%">
							</div>
						</div>
							...
							<div class="col-sm-6">
								<div class="row">
									<div class="col-sm-6">
										...
										<input type="text" onkeypress="return testNum(event, this,2);" class="form-control duree" min="0" placeholder="Nombre de jours" name='POS_VAL_RUB_NBR' required="true" data-parsley-pattern="[0-9][0-9]?" data-parsley-trigger="keyup" value="{POS_VAL_RUB_NBR}"  id="d1" style="width: 100%">
									</div>
									<div class="col-sm-6">
										<label for="bio">Dur&eacute;e (en heure) :</label>
										<select class="form-control dureedebselect" readonly=true  name='POS_VAL_RUB_HRA' value='{POS_VAL_RUB_HRA}'>
				...
				<div class="step-footer text-center">
					...
					<input class="btn col-sm-2" type="submit" value="SUIVANT" id="app" style="font-size: 12px;">
