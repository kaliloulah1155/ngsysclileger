    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: center;">Type de demande</th>
                <th style="min-width: 100px;text-align: center;">Motif</th>
                <!-- <th style="min-width: 100px;text-align: left;">Projet</th> -->
                <th style="min-width: 100px;text-align: left;">Dur&#233;e en jour</th>
                <th style="min-width: 100px;text-align: center;">Date depart</th>
