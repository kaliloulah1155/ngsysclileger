					...
					<div class="col2_partie" style="padding-top: 2%;">
						<div class="row">
							...
							<div class="col-sm-4" style="margin-top: 13px">
								...
								<input type="text" name="POS_VAL_RUB_DFI" value="{POS_VAL_RUB_DFI}" placeholder="jj/mm/aaaa" class="form-control dateFin"  readonly='true' style="width: 100%;" required="true" data-parsley-trigger="keyup">
							</div>
						...
						<div class="row" style="margin-top: 13px">
							<div class="col-sm-12">
								<label>Motif de licenciement <span class='text'></span> :</label>
								<textarea type="text" name='POS_VAL_RUB_MPO' required="true"  rows="3" class="form-control text" style="width: 100%; resize: none">{POS_VAL_RUB_MPO}</textarea>
							</div>
						</div>
	...
	<script>
	 ...
	 //fin données de l'utilisateur connecté
		$(document).ready(function (){
	        ...
	        $('#formlicenc').submit(function(event){
