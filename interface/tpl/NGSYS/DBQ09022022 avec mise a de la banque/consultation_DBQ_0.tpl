									...
									<div class="col2_partie" style="padding-top: 3%;">
										<div class="form-group">
										   	<label for="bio">Nouvelle Banque :</label>
						   					 <select  name='POS_VAL_RUB_NBQ' id="nvlle_bnq" class="form-control banque" rows="1" style="margin: 0% 0%" rows="1" style="width: 100%;" >
														...
														<input type="text" name='POS_VAL_CTRL_NBQ' id='POS_VAL_CTRL_NBQ' value="{POS_VAL_RUB_NBQ}" />
										</div>
										<div class="form-group">
						  				 	<input type="text"class="form-control rib" id="nveau_rib" name='POS_VAL_RUB_NRI' value="{POS_VAL_RUB_NRI}" data-parsley-required="true" data-parsley-trigger="keyup" readonly="true" style="width: 100%;">
										</div>
