					...
					<div class="col12_partie" style="padding-top: 3%;">
						<div class="row" style="margin: 0.5% 0%">
							<div class="col-sm-3" style="margin-top: 5px;">
								<label style="font-weight: 100;font-size: 13px;">Matricule : </label>
								<input type="text" name='POS_VAL_RUB_MAT' value="{POS_VAL_RUB_MAT}" placeholder="Matricule"  class="form-control matricul" style="font-weight: 100;font-size: 13px;"/>
							</div>
						...
						<div class="form-group row" style="margin: 0.5% 0%">  
							<div class="col-sm-3" style="margin-top: 5px">
								<label style="font-weight: 100;font-size: 13px;">Civilit&eacute; : </label>
								<select id="selection" name='POS_VAL_RUB_CIV' class="form-control civilite" style="width: 100%;font-weight: 100;font-size: 13px;"    data-parsley-required="true">
						...
						<div class="form-group row" style="margin: 0.5% 0%">
							...
							<div class="col-sm-3" style="margin-top: 5px">
								...
								<input type="text" id="date1" name="POS_VAL_RUB_DNS" value="{POS_VAL_RUB_DNS}" class="form-control" data-parsley-required="true" style="width: 100%;" placeholder="01/01/2020">
							</div>
							<div class="col-sm-3" style="margin-top: 5px">
