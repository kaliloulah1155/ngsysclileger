...
<body class='tpl_recherche_fiche tpl_recherche_fiche_prs' onLoad='initTplRecherche();'>
								...
								<div class="fields-row" >
									<div class="  col-lg-10 col-md-10 col-sm-12 col-xs-12" style="text-align: center;height: 12vh;">
											<div style="border: 1px solid; padding: 2px; float:right;margin-right: 5%;display: none;" class="d-inline-block">
												<a href="javascript:charger_vocabulaire(document.principal.POS_TYPEDOC.value, 'MEL', 'POS_VAL_RUB_MEL')"><div class='iconvocmonolie' id='img_voc_MEL' title='Libell�'></div></a>
											</div>
