							...
							<div class="row">
								...
								<div class="col2_partie" style="padding: 2%;">
									<div class="row">
										...
										<input type="text"class="form-control intposte" placeholder="Intitul&#233; du poste" style="width: 100%;height:35px;padding: 2%;border-radius:3px;" value="" />
										</div>
										<div class="col-sm-4">
											<label for="bio">D&#233;partement :</label>
											<select name="category" class="form-control selectDeps" style="width: 100%;">
											    <option value="0">Veuillez s&#233;lectionner</option>
											</select>
										</div>
										<div class="col-sm-4">
											<label for="bio">Service :</label>
											<select name="category" class="form-control selectServs" style="width: 100%;">
											    <option value="0">Veuillez s&#233;lectionner</option>
											</select>
										</div>
									</div>
									...
									<div class="row" style="margin-top: 13px;">
										<div class="col-sm-4">
											...
											<select id="interimaire" class="form-control selectOpes" style="width: 100%;">
											    <option value="0">Veuillez s&#233;lectionner</option>
											</select>
										</div>
										<div class="col-sm-4">
											<label for="bio">Hi&#233;rarchie fonctionnelle :</label>
											<select name="category" class="form-control selectFonts" style="width: 100%;">
											    <option value="0">Veuillez s&#233;lectionner</option>
											</select>
										</div>
										<div class="col-sm-4">
											...
											<table class="table">
										        <tbody class="exterieures">
										          <tr>
										            <td>
														<select name="category" class="form-control selectExts" style="width: 100%;">
														    <option value="0">Veuillez s&#233;lectionner</option>
														</select>
										            </td>
										          </tr>
										...
										<div class="col-sm-12">
											<table class="table tablerelation" style="margin-top: -9px;">
										        <tbody class="relation">
											          <tr>
											            <td class="col-sm-6">
											            	<select name="category" class="form-control selectIntDeps" style="width: 100%;">
															    <option value="0">D&#233;partement</option>
															</select>
											            </td>
											            <td class="col-sm-6">
											            	<select name="category" class="form-control selectIntServs" style="width: 100%;">
											...
											<div class="col-sm-12">
												<table class="table tableactivites" style="margin-top: -9px;">
											        <tbody class="activite">
												          <tr>
												            <td class="col-sm-6">
												            	<select name="category" class="form-control selectLibPost" style="width: 100%;">
																    <option value="0">Libell&#233;</option>
																</select>
												            </td>
												            <td class="col-sm-6">
												            	<select name="category" class="form-control selectTitbPost" style="width: 100%;">
						        ...
						        <tbody class="mission">
						          <tr>
						            <td>
										...
										<input type="hidden" name="POS_VAL_RUB_MPO" value="{POS_VAL_RUB_MPO}">
						            </td>
						          </tr>
						        </tbody>
						    </table>
						        ...
						        <tbody class="indicateur">
						          <tr>
						            <td>
										...
										<input type="hidden" name="POS_VAL_RUB_IPE" value="POS_VAL_RUB_IPE">
						            </td>
						          </tr>
						        </tbody>
						    </table>
							...
							<table class="table" id="table_tache" style="width: 100%;margin: auto;">
								<tbody  class="tableL">
									...
									<tr>
										...
										<td style="width: 45px; border: 1px solid">
											<select name="category" class="form-control selectForServsI diplome1" style="width: 100%;">
 											</select>
										</td>
										<td style="width: 45px; border: 1px solid">
											<select name="category" class="form-control selectforServsE diplome2" style="width: 100%;">
 											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td style="width: 45px; border: 1px solid">
											<input type="number" min="0" class="form-control" placeholder="Exp&#233;rience professionnelle">
										</td>
										<td style="width: 45px; border: 1px solid">
											<input type="number" min="0" class="form-control" placeholder="Exp&#233;rience professionnelle">
										</td>
									...
									<tr>
										...
										<td style="width: 45px; border: 1px solid">
											<textarea class="form-control"   style="width: 100%;resize: none"  rows="2"></textarea>
										</td>
										<td style="width: 45px; border: 1px solid">
											<textarea class="form-control"   style="width: 100%;resize: none"  rows="2"></textarea>
										</td>
					...
					<div class="row" style="margin-top: 17px;">
						<div class="col-sm-4" style="padding-left: 30px">
							...
							<span style="width: 100%;">
								<input type="checkbox" class="cbk1" value="OUI">
								<i>Pas significatif</i>
							</span><br>
							<span style="width: 100%;">
								<input type="checkbox" value="Normale">
								<i>Normale</i>
							</span><br>
							<span style="width: 100%;">
							...
							<span style="width: 100%;">
								<input type="checkbox" value="Tres forte">
								<i>Tr&#232;s forte</i>
							</span>
						</div>
						<div class="col-sm-4" style="padding-left: 30px">
							...
							<span style="width: 100%;">
								<input type="checkbox" value="Sans objet">
								<i>Sans objet</i>
							</span><br>
							<span style="width: 100%;">
								<input type="checkbox" value="Normale">
							...
							<span style="width: 100%;">
								<input type="checkbox" value="Importante">
								<i>Importante</i>
							</span><br>
							<span style="width: 100%;">
								<input type="checkbox" value="Tres Importante">
								<i>Tr&#232;s Importante</i>
							</span>
						</div>
						<div class="col-sm-4" style="padding-left: 30px">
							...
							<span style="width: 100%;">
								<input type="checkbox" value="Pas significatif">
								<i>Pas significatif</i>
							</span><br>
							<span style="width: 100%;">
								<input type="checkbox" value="Normale">
							...
							<span class="btn" id="ligne_Dim" style="float: right;margin-right: 70%;color: #FFF;background: #4a67b3;margin-top: -2.5%;">Ajouter une ligne</span>
											...
											<table class="table" id="table_tache" style="width: 100%;margin: auto;">
												<tbody>
													...
													<tr>
														...
														<td style="width: 45px; border: 1px solid">
															<select name="category" class="form-control selectForServsI" style="width: 100%;">
															    <option value="0">Service</option>
															</select>
														</td>
														<td style="width: 45px; border: 1px solid">
															<select name="category" class="form-control selectforServsE" style="width: 100%;">
															    <option value="0">Service</option>
															</select>
														</td>
													</tr>
													<tr>
														...
														<td style="width: 45px; border: 1px solid">
															<input type="text" class="form-control" placeholder="Sp&#233;cialit&#233;" style="width: 100%;">
														</td>
														<td style="width: 45px; border: 1px solid">
															<input type="text" class="form-control" placeholder="Sp&#233;cialit&#233;" style="width: 100%;">
														</td>
													...
													<tr>
														...
														<td style="width: 45px; border: 1px solid">
															<input type="number" min="0" class="form-control" placeholder="Exp&#233;rience professionnelle"style="width: 100%;">
														</td>
													</tr>
													<tr>
														<td style="width: 30px; border: 1px solid">
									...
									<div class="row" style="margin-top: 17px;">
										<div class="col-sm-4" style="padding-left: 30px">
											...
											<span style="width: 100%;">
												<input type="checkbox" value="Tr&#232;s forte">
												<i>Tr&#232;s forte</i>
											</span>
										</div>
										<div class="col-sm-4" style="padding-left: 30px">
											...
											<span style="width: 100%;">
												<input type="checkbox" value="Tr&#232;s Importante">
												<i>Tr&#232;s Importante</i>
											</span>
										</div>
										<div class="col-sm-4" style="padding-left: 30px">
										...
										<div class="col-sm-4">
											<table class="table tableDominante">
										        <tbody class="dominante">
										        	<tr>
										        		<td>
										        			<select name="category" class="form-control selectDoms" style="width: 100%;margin-top: -2%">
																<option value="0">Veuillez s&#233;lectionner</option>
															</select>
										        		</td>
										        	</tr>
