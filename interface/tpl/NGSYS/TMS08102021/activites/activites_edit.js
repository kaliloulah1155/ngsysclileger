		       ...
		       ///tableau
		       	...
		       	var html = '';
					    ...
					    html += '</td>' +
								...
								'</td>'+
								'<td>'+
								      '<input type="checkbox"  checked="false" style="margin-left:50%" name="hsu[]" class="hsu" > '+
								'</td>'+
								'<td>'+
								      '<input type="checkbox" checked="false" name="ferie[]" class="ferie" style="margin-left:50%">'+ 
								'</td>'+
					    '</tr>';      
