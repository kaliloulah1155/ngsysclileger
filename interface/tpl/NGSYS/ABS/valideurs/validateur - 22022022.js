...
class WorkflowMailer{
   ...
   constructor(email,titre,contenu,app){
       ...
       this.link2="/"+app+"/configuration_w/pos_mail/pos_mailer.php";
   ...
   //Appel du lien 
    ...
    // alert(typeDemande);
        ...
        var valideur =(validator,initiateur_wk,app)=> { 
             const valid= new WorkflowMailer(validator,`${typedmd} N\u00b0 ${numdmd}`,
                 `   
                       TYPE :  DEMANDE ${typedmd} <br/>
                       BONJOUR ${nomInterimaire}, <br/>
                       VOUS AVEZ RECU UNE DEMANDE POUR VALIDATION DE ${typedmd} DE LA PART DE ${nomInitiateur} ${prenomInitiateur}.<br/>
