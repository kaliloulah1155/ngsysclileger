...
<body class="fluid">
    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: left;">Service</th>
                <th style="min-width: 100px;text-align: left;">Date</th>
                <th style="min-width: 100px;text-align: left;">Heure de debut</th>
                <th style="min-width: 100px;text-align: left;">Heure de fin</th>
                <th style="min-width: 100px;text-align: left;">Dur&#233;e</th>
                <th style="min-width: 100px;text-align: left;">Montant</th>
    ...
    <script>
        ...
        $(document).on('click','.modifier',function(){
          ...
          window.location.href='/<?php echo $_GET["APPLI"] ?>/interface/session/principal/consultation/consulter_index.php?MODE=MODIFICATION&POS_NUM_DOC='+numposeidon+'&POS_TYPEDOC=HSU&POS_NUM_FICHE=0';
