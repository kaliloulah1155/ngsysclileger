				...
				<div class="  col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<!-- debut -->
						<nav class="container-fluid">
							<table class="test" id="table_tache" style="width: 100%;text-align: center;">
								<thead>
									<tr>
							<table class="test" id="table_tache" style="width: 100%;text-align: center;">
										<td style="width: 20px;border:1px solid transparent;text-align: center;">
											<span style="width: 100%;"></span>
										</td>
										<td style="width: 100px;height: 7vh;border:none;background: #4a67b3;border-top-left-radius: 5px;text-align: center;padding-top: 7px">
											<span style="width: 100%;font-size: 13px; color: #fff;font-weight: 1;">Date</span>
										</td>
										<td style="width: 100px;height: 7vh;border:none;background: #4a67b3;text-align: center;padding-top: 7px">
										...
										<td style="width: 300px;height: 7vh;border:none;background: #4a67b3;border-top-right-radius: 5px;text-align: center;padding-top: 7px">
								...
								<tbody class="tableL">
									<tr>
										...
										<td style="width: 100px;border:none;">
											<input type="number" name="POS_VAL_RUB_MHT" value="{POS_VAL_RUB_MHT}" style="width: 100%; height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" min='0' rows="2" placeholder="" class="form-control montant">
										</td>
										<td style="width: 50px;border:none;padding-top: 17px">
											<input name="select" type="checkbox" name="POS_VAL_RUB_CHK" value="{POS_VAL_RUB_CHK}" style="width: 80%;font-size: 12px;margin-left: -20%;">
										</td>
									</tr>
								</tbody>
							</table>
	 	...
	 	$(document).ready(function (){
			...
			function  addRow(){ 
			  	var ligne ='<tr>'+
						...
						'</td>'+
						'<td style="width: 100px;border:none;">'+
								'<input type="text" name="heurein[]" style="width: 100%;height: 11vh;background: transparent;border: 1px solid;margin-top: 2px" placeholder="jj / mm / aaaa"  class="form-control heurein">'+
						'</td>'+
						'<td style="width: 100px;border:none;">'+
