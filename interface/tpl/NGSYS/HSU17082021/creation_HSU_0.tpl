	...
	<script>	 
		 ...
		 $(document).ready(function () {
			...
			$('.tableL').delegate('.heurein,.heureout,.date','change',function(){
                ...
                var timeMat= new Date("01/01/2010 " + heureConstMat);
                var timeSoir= new Date("01/01/2010 " + heureConstSoir);
                ...
                var montantJour= paieQuod + (0.15*paieQuod);
                var montantJour2= paieQuod + (0.5*paieQuod);
                    ...
                    if(timeEnd<= timeSoir){
                        var differenteTime= timeSoir-timeEnd;
                ...
                if(timeStart>=timeMat && timeEnd<=timeSoir){
                    if(getJour==weekday1[0]){

                        $('.montant').val(montantSunday);
                    }else{
                    }
