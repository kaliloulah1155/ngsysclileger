...
$result = pg_query("SELECT * FROM public.tache_journalieres WHERE email='".$user_email."' AND code='".$loadcode."' ");
...
if ($find!=0){
	...
	//UPDATE
	 ...
	 pg_query(" DELETE FROM public.tache_journalieres WHERE email='".$user_email."' AND code='".$loadcode."'");
	  ...
	  foreach ($activites as $key => $v) {
             ...
             /*
               ...
               $query1="INSERT INTO public.tache_journalieres(
                    email, activites, taches, heurein, heureout, duree,taux, resultat, departement, service,date_enreg,hs,ferie,code)
                    VALUES (  
                           '".$user_email."',
                            '".$v."',
                            '".$taches[$key]."',
