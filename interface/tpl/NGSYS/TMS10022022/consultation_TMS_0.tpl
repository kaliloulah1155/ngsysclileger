		   ...
		   <div class="tab-pane fade active in"  id="tabs-1" style="margin-top: 0;">
				<div class="  col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<!-- debut -->
						<nav class="container-fluid">
						    ...
						    <input type="hidden" class="loadcode" name="POS_VAL_RUB_COD" value="{POS_VAL_RUB_COD}" style="width: 30%;" />

						    <input type="hidden" class="totalduree" name="POS_VAL_RUB_U3" value="{POS_VAL_RUB_U3}" style="width: 30%;" />
						    <input type="hidden" class="etat" name="POS_VAL_RUB_X8" value="{POS_VAL_RUB_X8}" style="width: 30%;" />

						    <input type="hidden" class="vsalaire_base" name="POS_VAL_RUB_SAB" value="{POS_VAL_RUB_SAB}"  style="width: 30%;">
						    <!--Donnée relative aux traitement des heures sup -->
              ...
              <span class="resul"></span>
									 ...
									 <thead>
										<tr>
											...
											<td style="width: 200px;height: 7vh;border:none;background: #4a67b3;text-align: center;padding-top: 6px">
												<span style="width: 100%;font-size: 12px; color: #fff;font-weight: 1;padding: 5px">R&#233;sultat</span>
											</td>
											<td style="width: 50px;height: 7vh;border:none;text-align: center;padding-top: 6px">
												<span style="width: 50%;font-size: 12px; color: black;font-weight: 1;padding: 5px">Heure Sup</span>
											</td>
											<td style="width: 50px;height: 7vh;border:none;text-align: center;padding-top: 6px">
												<span style="width: 50%;font-size: 12px; color: black;font-weight: 1;padding: 5px">Jrs feri&#233;</span>
											</td>
							...
							<!--fin table  -->
								...
								<!-- Les champs de Durée totale et Taux journalier -->
