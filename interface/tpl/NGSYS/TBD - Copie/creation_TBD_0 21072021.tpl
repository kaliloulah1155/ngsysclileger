	         ...
	         <div class="container aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
	            ...
	            <div class="row">
	               <div class="col-lg-12" style="border-radius: 5px;margin-top: -5%;">
	                  <div class="owl-carousel owl-loaded owl-drag" style="position: fixed; top: 2%;">
		                    ...
		                    <div class="accordion-item">
		                        ...
		                        <div id="collapseOneRH" class="accordion-collapse collapse " aria-labelledby="headingOne" data-mdb-parent="#RessourcesHumaines">
		                           <div class="accordion-body" style="background: rgb(255 255 255 / 90%);font-family: 'Open Sans', sans-serif;font-size: 14px">
		                              	<ul>
			                                <li>
											   <a  href="javascript:void lanceBibBal('/{NOM_APPLICATION}/interface/session/principal/resultat/rechercher_db.php&TYPE_RECHERCHE=RECHERCHE_BAL&POS_QUEST_NOM=Bal_ABS_nv&POS_QUEST_PUBLIC=1', 'QUESTION_BAL');">En attente (0)</a>
											</li>
			                                <li><a href="javadcript:void(0)">Valider (0)</a></li>
			                                <li><a href="javadcript:void(0)">Refuser (0)</a></li>
		                              	</ul>
		                           </div>
		                        </div>
		                    </div>
