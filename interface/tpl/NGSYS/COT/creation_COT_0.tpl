...
<body  class='tpl_creation tpl_creation_cot' onLoad='initTplCreation();' style="background-color: transparent;font-family: 'Times New Roman';">
	<form name='principal' id="formcontrat" class="cform" ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();'>
		...
		<!--fin données de l'utilisateur connecté -->
 		<div class="col_list">
			...
			<a style="display:none" href="javascript:void lanceBibBal('/{NOM_APPLICATION}/interface/session/principal/resultat/rechercher_db.php&TYPE_RECHERCHE=RECHERCHE_BAL&POS_QUEST_NOM=Bal_COT_nv&POS_QUEST_PUBLIC=1', 'QUESTION_BAL');">
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-sm-6">
									...
									<select id="select_contrat" name='POS_VAL_RUB_TYE' class="form-control type_contrat" style="width: 100%;" required="true" data-parsley-trigger="keyup">
									...
									<input type="hidden"  class="interselectcontrat" name='POS_VAL_CTRL_TYE' id='POS_VAL_CTRL_TYE' value='{POS_VAL_RUB_TYE}' required="true">
								...
								<div class="col-sm-6" style="margin-top: 13px">
									<label>Salaire <span class='text' ></span> :</label>
									<input type="text"  onkeypress="return testNum(event, this, 2);" name="POS_VAL_RUB_SAL" value="{POS_VAL_RUB_SAL}" class="form-control montant_net" maxlength="9" placeholder="Salaire" style="width: 100%;" required="true" data-parsley-trigger="keyup">
								</div>
								<!-- montant en lettre -->
								<input type="hidden" name="POS_VAL_RUB_MDT"  class="form-control montant_letter" />

								<div class="col-sm-6" style="margin-top: 13px">
									<label>Date de signature <span class='text' ></span> :</label>
									<input type="text" name="POS_VAL_RUB_DSG" value="{POS_VAL_RUB_DSG}" id="dateSig" placeholder="jj/mm/aaaa" class="form-control champDate" style="width: 100%;" required="true" data-parsley-required="true" data-parsley-trigger="keyup">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-sm-4" style="margin-top: 13px;display: none;" id="diplomes">
									...
									<select   name='POS_VAL_RUB_DIP' class="form-control selectDip diplome" style="width: 100%;" required="true">
									</select>
	...
	<script>
	 ...
	 var prof_util = "{PROFIL_UTILISATEUR}";	 
	 	...
	 	$(document).ready(function (){ 
	        ...
	        $('#formcontrat').submit(function(event){
