...
<p>
Par ce contrat, la société '.$entreprise.'  sollicite <b>'.$civilite.' '.$nom.' '.$prenoms.'</b> qui accepte d’exécuter une prestation de travail en qualité de <b>'.strtoupper($fonction).'</b> conformément à sa fiche de poste annexée au présent contrat.'.$majpronom.'  exercera ses fonctions sous l’autorité et selon les directives de l’employeur, à qui '.$pronom.' rendra compte de ses prestations de travail.
</p>
