...
class PDF extends FPDF
{
 ...
 $stage='';
  ...
  $pdf->Ln(10); // Line gap
  $pdf->SetX(20); // abscissa of Horizontal position 
  $pdf->MultiCell(160,10,utf8_decode($civ.' '.$nom.' '.$prenom.' Né le '.$datenaiss.', a effectué un stage au sein de notre établissement dans la période allant du '.$date_entree.' au '.$date_fin.' . '));
