...
.then(data => {
	...
	let results = data.data[0];
	 console.log('resulat',results);
	var sexe = $('.viewsex').val(results.sexe);
    var fullname = $('.viewlib').val(results.fullname);
	var fonction = $('.viewfonct').val(results.fonction);
})
