...
<head>
    ...
    <title>Consultation de licenciement</title>
								...
								<div class="col-sm-6 mt-5" style="margin-top: 0%;">
									...
									<div class="col2_partie" style="padding-top: 5%;">
										...
										<div class="form-group row">
											<div class="col-sm-5">
												<label>Nom</label>
												<input type="text" name='POS_VAL_RUB_NOM'  value="{POS_VAL_RUB_NOM}" placeholder="Nom" class="form-control" style="width: 100%" data-parsley-required="true" >
											</div>
											<div class="col-sm-7">
												<label>Pr&#233;noms</label>
												<input type="text" name='POS_VAL_RUB_PRE'  value="{POS_VAL_RUB_PRE}"  placeholder="Pr&#233;noms" class="form-control" style="width: 100%" data-parsley-required="true" >
											</div>
										</div>
										<!-- Fonction & Anciennete -->
										<div class="form-group row">
									...
									<div class="col2_partie" style="padding: 11%;">
										...
										<div class="form-group row">
											<div class="col-sm-6">
												...
												<input type="text" name='POS_VAL_RUB_CAT' value="{POS_VAL_RUB_CAT}"  placeholder="Pr&eacute;avis" class="form-control" style="width: 100%">
											</div>
										</div>
