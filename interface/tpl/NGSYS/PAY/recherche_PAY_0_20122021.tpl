								...
								<div class="fields-row" >
									<div class="  col-lg-10 col-md-10 col-sm-12 col-xs-12" style="text-align: center;height: 12vh;">
											<div style="border: 1px solid; padding: 2px; float:right;margin-right: 5%;display: none;" class="d-inline-block">
												<a href="javascript:charger_vocabulaire(document.principal.POS_TYPEDOC.value, 'CRE', 'POS_VAL_RUB_CRE')"><div class='iconvocmonolie' id='img_voc_CRE' title='Libellé'></div></a>
											</div>
											<div class="input-group d-inline-block">
												<label class="input-group-addon" for="id_rub_MEL" >E-mail </label>
												<input class="form-control email"  name='POS_VAL_RUB_MEL' id='id_rub_MEL' size='20' value="{POS_VAL_RUB_MEL}"  onBlur="javascript:maximum(this,'119')"
