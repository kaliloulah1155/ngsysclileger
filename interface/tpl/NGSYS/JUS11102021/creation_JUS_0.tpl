					...
					<div class="col-sm-12 pt-2" style="border: 1px solid #4a67b3">
						...
						<div class="row" style="margin-top: 2%">
							<div class="col-sm-6">
								...
								<textarea  name='POS_VAL_RUB_COM'class="form-control motif" id="motif"  readonly="true" style="width: 100%;resize: none" rows="2" required="true" data-parsley-trigger="keyup"> {POS_VAL_RUB_COM}</textarea>
							</div>
							<div class="col-sm-6">
