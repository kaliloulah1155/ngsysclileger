		...
		<nav class="container-fluid">
					...
					<div class="col12_partie" style="padding-top: 3%;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-3" style="margin: 0.5% 0%">
								...
								<input type="text" name='POS_VAL_RUB_QUA'value="{POS_VAL_RUB_QUA}" placeholder="Quartier" class="form-control" data-parsley-required="true" data-parsley-trigger="keyup" data-parsley-pattern="^[a-zA-Z0-9'_ ]*$">
							</div>
							<div class="col-sm-3" style="margin: 0.5% 0%">
								<label>E-mail</label>
						...
						<div class="form-group row">
							...
							<div class="col-sm-3" style="margin: 1% 0%">
								...
								<select id="selection" name='POS_VAL_RUB_FLN' class="form-control" rows="1" data-parsley-required="true" style="margin: 0% 0%">
									<option value="0" disabled="disabled">Veuillez selectionner</option>
			...
			<div class="row" style="margin-top: 5%">
					...
					<div class="col2_partie" style="padding-top: 10px;">
						...
						<div class="form-group row">
							<div class="col-sm-6" style="margin: -0.5% 0%">
								...
								<input type="text" name='POS_VAL_RUB_CAT'value="{POS_VAL_RUB_CAT}" placeholder="Cat&eacute;gorie" class="form-control" data-parsley-pattern="^[a-zA-Z'_ ]*$" data-parsley-trigger="keyup" />
							</div>
							<div class="col-sm-6" style="margin: -0.5% 0%">
				...
				<div class="col-sm-6 mt-5">
					...
					<div class="col2_partie" style="padding-top: 50px;padding-bottom: 42px;">
						<!-- Salaire Net -->
						<div class="form-group row">
