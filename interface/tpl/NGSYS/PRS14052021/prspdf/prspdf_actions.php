...
// Send Headers
    ...
    require('../../../../../configuration_w/PDF/fpdf.php');
     ...
     $numposeidon= $_GET['numposeidon'] ;
      ...
      $query =" SELECT  \"NOM\",\"PRE\",\"DNS\",\"LNS\",\"NAT\",\"NPI\",\"NTP\",\"SIF\",\"NEF\",\"CNE\",\"TEL\",\"BP\",\"DEI\",\"FON\",\"CNP\",\"MAT\",\"TYE\",\"DUR\",\"DPT\",\"AVT\",\"CAT\",\"DCR\" ,\"NMG\",\"PMG\",\"SLT\",\"RIB\",\"BQE\",\"PAC\",\"NTC\",\"FLN\",\"CIV\" ,\"NEP\" FROM public.pos_tab_index_prs WHERE  \"NUD\" ='".$numposeidon."'";
     ...
     if ($civilite=='MLLE') {
      ...
      $civ='Mlle';
        ...
        if($civ=='Mme'){
        $pdf->Cell(20,7,( utf8_decode('epoux : ')),0,0  );
 ...
 : ")),0,0  );
        ...
        $pdf->Cell(40,8,( utf8_decode( "ibson@ins.fr")),0,1);
        ...
        $pdf->Line(10, 205, 197,205); //haut
        $pdf->Line(10, 205, 10,265); //gauche
        $pdf->Line(197, 265, 197,205); //droite
        $pdf->Line(10, 265, 197,265); //bas
