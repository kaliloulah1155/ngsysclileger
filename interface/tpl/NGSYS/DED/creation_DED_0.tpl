...
<head>
    ...
    <title>Engagement de d&eacute;pense</title>
	...
	<style>
		...
		.btn{
			width: 150px;
			position: relative;
			border: 1px solid #101D2C !important;
			background: grey;
			color: #ffff;
			margin-top: 3%;
			margin-bottom: 3%;
...
<body  class='tpl_creation tpl_creation_trt' onLoad='initTplCreation();' style="background-color: transparent;font-family: 'Times New Roman';">
			...
			<div class="row" style="margin-top: 1%">
				...
				<div class="col-sm-6 mt-5" style="margin-top: -5.6%;">
					<div class="col1_partie text-center">
						<span class="title text-while">DEMANDEUR</span>
					</div>
					<div class="col2_partie" style="padding-top: 5%;padding-bottom: 3%;">
						<div class="form-group">
						   <!-- <label for="bio">Client :</label> -->
						   <textarea class="form-control" id="bio" rows="1" placeholder="Client" style="width: 90%;resize: none"></textarea>
						</div>
						<div class="form-group">
						   <!-- <label for="bio">Projet :</label> -->
						   <textarea class="form-control" id="bio" rows="1" placeholder="Projet" style="width: 90%;resize: none"></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						   <!-- <label for="bio">Descriptif (motif) :</label> -->
						   <textarea class="form-control" id="bio" rows="1" placeholder="Descriptif (motif)" style="width: 90%;resize: none"></textarea>
						</div>
						<div class="form-group">
						   <!-- <label for="bio">Montant :</label> -->
						   <textarea class="form-control" id="bio" rows="1" placeholder="Montant" style="width: 90%;resize: none"></textarea>
						</div>
						<div class="form-group">
							<label for="bio">Date d&#146;execution :</label>
							<input type="date" class="form-control" id="bio" rows="1" style="width: 89%;resize: none">
						</div>
					</div>	
				</div>
						<!-- 12_ 2 infos -->
				<div class="col-sm-6 mt-5"style="margin-top: -5.6%;">
					<div class="col1_partie text-center">
						<span class="title text-while">VALIDATION</span>
					</div>
					<div class="col2_partie" style="padding-top: 2.9%;padding-bottom: 3%;">
						<div class="form-group">
						   <label for="selection">Avis manager</label>
							<div class="row">
								<div class="col-sm-7" rows="1">
									<select id="selection" class="form-control" style="width: 100%">
										<option value="">Ligne budgetaire</option>
										<option value="">Option 1</option>
										<option value="">Option 2</option>
										<option value="">Option 3</option>
									</select>
								</div>
								<div class="col-sm-4" rows="1">
									<!-- <label for="bio">Solde :</label> -->
									<input class="form-control" id="bio" rows="1" placeholder="Soldes" style="width: 95%;">
								</div>
							</div>
							<select id="selection" class="form-control" style="width: 90%">
								<option value="">Veillez s&eacute;lectiooner le type</option>
						...
						<div class="form-group">
						   ...
						   <textarea class="form-control" id="bio" rows="2" placeholder="Commentaire" style="width: 90%;resize: none;margin-top: -4%;"></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						   <!-- <label for="bio">Commentaire :</label> -->
						   <textarea class="form-control" id="bio" rows="2" placeholder="Commentaire" style="width: 90%;resize: none"></textarea>
						</div>
						<div class="form-group">
				...
				<div class="col-sm-6 text-center">
					<div type="resset" class="btn btn_left" onclick="{CODE_ACTION_FERMER}">FERMER</div>
				</div>
				<div class="col-sm-6 text-center">
					<div type="submit" class="btn btn_right">ENREGISTRER</div>
				</div>
			</div>
		</nav>
