    ...
    $domicile='';
     ...
     if ($natpiece=='CARTE CONSULAIRE') {
       $libellepiece='de la Carte Consulaire';
          ...
          $query_cot ="SELECT  \"FON\",\"ENT\",\"MOI\",\"M1\",\"DDT\",\"DEC\",\"MDT\",\"SAL\",\"DSG\",\"COM\"
...
<p>
NGSER et '.$determinant.' salarié'.$accord.' étant individuellement désignés <b>« la partie »</b> et collectivement 
<b>« les parties »</b>
...
<p>
Par ce contrat, NGSER sollicite <b>'.$civilite.' '.$nom.' '.$prenoms.' </b> en qualité de <b>'.strtoupper($fonction).'</b>, pour  l’exécution des projets de '.$entreprise.'. 
</p>
...
<p>
La rémunération mensuelle nette de l’employé'.$accord.' est de <b>'.strtolower($salaire_lettre).' ('.$salaire.')  francs CFA.</b>
</p>
<p>
...
<b>ARTICLE 5 : DUREE -ENTREE EN VIGUEUR </b>
 ...
 <p>
Ce présent contrat de travail est conclu pour une période  de '.strtolower($duree_lettre).'  ('.$duree_mois.') mois qui prend effet à compter du '.$date_deb_contrat.' et expire le '.$date_fin_contrat.' . 
 </p>
...
<p>
Notamment, '.$pronom.' ne devra pas divulguer à quiconque les méthodes, recommandations, créations, devis, études, projets, savoir-faire de l’entreprise résultant de travaux réalisés dans l’entreprise qui sont couverts par le secret professionnel le plus strict.'.$majdeterminant.' sera lié'.$accord.' par la même obligation vis-à-vis de tout renseignement ou document dont il aura pris connaissance chez les clients de la société.
</p>
<p>
...
<p>
'.$majdeterminant.' salarié'.$accord.' ne pourra, sans accord écrit de la Direction Générale de NGSER, publier aucune étude sous quelque forme que ce soit portant sur des travaux ou des informations couvertes par l’obligation de confidentialité. Cette obligation de confidentialité se prolongera après la cessation du contrat de travail, quelle qu’en soit la cause.
</p>
