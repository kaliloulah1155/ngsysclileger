...
<head>
    ...
    <title>Cr&eacute;ation fournisseur</title>
...
<body  class='tpl_creation tpl_creation_fou' onLoad='initTplCreation();' style="background-color: transparent;font-family: 'Times New Roman';">
			...
			<div class="row" style="margin-top: 7%">
				...
				<div class="col-sm-4 mt-5" style="margin-top: -5.6%;">
					<div class="col1_partie text-center">
						<span class="title text-while">IDENTIFICATION FOURNISSEUR</span>
					</div>
