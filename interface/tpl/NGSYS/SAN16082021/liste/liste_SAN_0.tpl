    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: left;">Nature de la sanction</th>
                <th style="min-width: 100px;text-align: center;">Date de faute</th>
                <th style="min-width: 100px;text-align: center;border-top-right-radius: 5px;">Actions</th>
            </tr>
        </thead>
        <tbody class="list_sanction">

           
        </tbody>
    </table>

     <script language='javascript' src="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/SAN/liste/listeAjaxSAN/load_liste_SAN.js"></script>
    <script language='javascript' src="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/SAN/excelsan/sanctionexcel.js"></script>
     ...
     //bouton oeil
        $(document).on('click','.modifier',function(){
            ...
            //alert(numposeidon);
         window.location.href='/<?php echo $_GET["APPLI"] ?>/interface/session/principal/consultation/consulter_index.php?MODE=MODIFICATION&POS_NUM_DOC='+numposeidon+'&POS_TYPEDOC=SAN&POS_NUM_FICHE=0';
        ...
        $(document).on('click','.supprimer',function(e){
                ...
                var link_url_del="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/SAN/liste/listeAjaxSAN/delete_SAN.php";
