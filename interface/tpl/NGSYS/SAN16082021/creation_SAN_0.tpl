...
<body  class='tpl_creation tpl_creation_san' onLoad='initTplCreation();' style="background-color: transparent;font-family: 'Times New Roman';">
	<form name='principal' id="formsanct" ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();' data-parsley-validate>
		...
		<div class="col_list">
			...
			<a style="display:none" href="javascript:void lanceBibBal('/{NOM_APPLICATION}/interface/session/principal/resultat/rechercher_db.php&TYPE_RECHERCHE=RECHERCHE_BAL&POS_QUEST_NOM=Bal_SAN_nv&POS_QUEST_PUBLIC=1', 'QUESTION_BAL');">
				<span style="color:#4a67b3;">Cliquez pour consulter la liste</span>
			</a>
			<a href="/{NOM_APPLICATION}/interface/tpl/{NOM_APPLICATION}/SAN/liste/liste_SAN_1.php?APPLI={NOM_APPLICATION}">
				<span style="color:#4a67b3;">Cliquez pour consulter la liste</span>
			</a>
		</div>
