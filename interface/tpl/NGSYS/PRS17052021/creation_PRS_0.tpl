					...
					<div class="col12_partie" style="padding-top: 3%;">
						<div class="row" style="margin: 0.5% 0%">
							<div class="col-sm-3" style="margin-top: 5px;">
								...
								<input type="text" name='POS_VAL_RUB_MAT' value="{POS_VAL_RUB_MAT}" placeholder="Matricule" data-parsley-required="true" class="form-control" data-parsley-pattern="^[A-Z0-9]*$" data-parsley-trigger="keyup" />
							</div>
						</div>
						...
						<div class="row" style="margin: 0.5% 0%">
							...
							<div class="col-sm-3" style="margin-top: 5px">
								...
								<select id="selection" rows="1" name='POS_VAL_RUB_SIF' data-parsley-required="true" class="form-control"  style="width: 100%;">
									<option value="" selected >Veuillez s&#233;lectionner</option>
