...
// Send Headers
    ...
    require('../../../../../configuration_w/PDF/fpdf.php');
     ...
     $numposeidon= $_GET['numposeidon'] ;
      ...
      $query =" SELECT  \"NOM\",\"PRE\",\"DNS\",\"LNS\",\"NAT\",\"NPI\",\"NTP\",\"SIF\",\"NEF\",\"CNE\",\"TPH\",\"BP\",\"DEI\",\"FON\",\"CNP\",\"MAT\",\"TYE\",\"DUR\",\"DPT\",\"AVT\",\"CAT\",\"DCR\" ,\"NMG\",\"PMG\",\"SLT\",\"RIB\",\"BQE\",\"PAC\",\"NTC\",\"FLN\",\"CIV\" ,\"NEP\",\"PRM\",\"TPM\",\"MEL\" FROM public.pos_tab_index_prs WHERE  \"NUD\" ='".$numposeidon."'";
