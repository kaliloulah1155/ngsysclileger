...
require('../../../../../configuration_w/tcpdf-master/tcpdf.php');
  ...
  /* $rq = pg_query($conn,"
   ...
   FROM 
           public.pos_tab_index_lic ORDER BY  \"NOM\" ASC
   "); */
    ...
    $query_lic_date="
            ...
            WHERE  \"DEI\" BETWEEN '".$date_deb."' AND '".$date_fin."' ORDER BY  \"NOM\" ASC
           ";
   ...
   if(!empty($email)){
    ...
    $query_lic_datemail="
            SELECT  \"NOM\",\"PRE\",\"FON\",\"AVA\",\"DEI\",\"NUD\"
            FROM pos_tab_index_lic 
            WHERE  \"DEI\" BETWEEN '".$date_deb."' AND '".$date_fin."' AND  \"INT\"='".strtolower($email)."' ORDER BY  \"NOM\" ASC
           ";
   ...
   while ($row = pg_fetch_row($contests_lic)) {
       ...
       $output .="
        <tr>
                   ...
                   <td style='width: 100px;border:none;'>
                      ".str_replace(',','.',number_format($row[3]))." FCFA"."
                   </td>
                   <td style='width: 100px;border:none;'>
                     ".$row[4]."
                   </td>
    ...
    public function Header() {
      ...
      //$image_file =K_PATH_IMAGES.'logo_example.jpg';
       $image_file =K_PATH_IMAGES.'ngser.jpg';
        ...
        $this->Cell(0, 10, 'LISTE DES LICENCIEMENTS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
 ...
 <p>
        ...
        <table class="jour"  align="center" cellpadding="2" border="1" width="100%">
	        <tr>
	           ...
	           <td   style="background-color:#2AD4FF;">ANCIENNETE</td>
	           <td   style="background-color:#2AD4FF;">DATE DE PRISE DE DECISION</td>
	        </tr>
