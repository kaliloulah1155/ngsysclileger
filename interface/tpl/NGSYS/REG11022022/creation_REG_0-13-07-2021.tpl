		...
		<nav class="container-fluid">
			<div class="col-sm-12 mt-5" style="margin-top: 3%;">
				...
				<div class="col2_partie">
					<span class="res" style="text-align: center;"> result</span>
					<div class="row" style="padding-top: 1%;padding-bottom: 2%">
						<div class="col-sm-6" style="margin-top: 13px">
							<label>Nom & pr&#233;noms :</label>
							<select id="selection" name='POS_VAL_RUB_CIV' data-parsley-required="true" class="form-control selectNom personnel" style="width: 100%;">
