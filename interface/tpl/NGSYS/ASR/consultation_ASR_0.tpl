...
<head>
    ...
    <title>Consultation Assurance</title>
...
<body  class='tpl_consultation tpl_consultation_asr' onLoad='initTplConsultation();{GRISE_CHAMP};' onBeforeUnLoad="{CODE_ACTION_UNLOAD}" style="background-color: transparent;font-family: 'Times New Roman';">
  <!-- <form name='principal' ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();'> -->

	<form name='principal'  id="formassurance" ACTION='{URL_ATTENTE}' method='POST' data-parsley-validate>
	...
	//  Fin Barre de progression 1
			...
			<script language='javascript' src="/{NOM_APPLICATION}/interface/tpl/{NOM_APPLICATION}/ASR/workflowASR.js"></script>
