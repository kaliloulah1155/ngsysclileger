...
$(document).on('input','.nom_pre',function(){
	 nom_pre=$(this).val();
});
...
$(document).on('click','.btn_search',function(e){
	...
	//console.log(date_search,nom_pre,service_s,departement_s);

	ajaxSearchTMS(user_email_s,date_search,nom_pre,service_s,departement_s);

  e.preventDefault();
});


function ajaxSearchTMS(user_email_s,date_search,nom_pre,service_s,departement_s) {
