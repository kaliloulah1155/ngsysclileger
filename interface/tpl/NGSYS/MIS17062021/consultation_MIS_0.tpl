...
<body  class='tpl_consultation tpl_consultation_mis' onLoad='initTplConsultation();{GRISE_CHAMP};' onBeforeUnLoad="{CODE_ACTION_UNLOAD}" style="background-color: transparent;font-family: 'Times New Roman';">
  <!-- <form name='principal' ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();'> -->
	...
	<form name='principal' id="formission" ACTION='{URL_ATTENTE}' method='POST' data-parsley-validate>
					   ...
					   <div class="circle1" style="display: none;">
						...
						<div class="circle1">
							...
							<div class="jumbotron pt-1" style="width: 30%; padding-top: 1%;padding-bottom: 3%;background: #4a67b3;color:#fff;border-radius:5px;z-index:999">
								...
								<span class="d-flex">
									<span class="pr-4" style="font-size: 13px; font-family: Times;">Visa :</span>
									<strong class="pt-1_pl-5 finance_visa  " style="font-size: 13px;">{POS_VAL_RUB_VC5}</strong>
								</span>
								<!-- Affichage de la date -->
								<span class="d-flex">
									<span class="pr-4" style="font-size: 13px; font-family: Times;padding-left: 3%">Date :</span>
						...
						<div class="acteur6">
							<div class="col-sm-4" style="padding-bottom: 3%">
								<label for="bio">FINANCE</label>
									<div class="info_group" style="display:flex;flex-direction:row">
										<input type="text" name='POS_VAL_RUB_A4F' value="{POS_VAL_RUB_A4F}" class="form-control" placeholder="" style="width: 80%;">
							...
							<div class="col-sm-2" style="padding-bottom: 3%">
								<label for="bio">Date</label>
								<input type="text" name='POS_VAL_RUB_DT7' value="{POS_VAL_RUB_DT7}" class="form-control" placeholder="" style="width: 100%;">
							</div>
							<div class="col-sm-5" style="padding-bottom: 3%">
								<label for="bio">Commentaire</label>
						...
						<div class="acteur6">
							<div class="col-sm-4" style="padding-bottom: 3%">
								<label for="bio">EMPLOYE</label>
									<div class="info_group" style="display:flex;flex-direction:row">
										<input type="text" name='POS_VAL_RUB_A4G' value="{POS_VAL_RUB_A4G}" class="form-control" placeholder="" style="width: 80%;">
							...
							<div class="col-sm-2" style="padding-bottom: 3%">
								<label for="bio">Date</label>
								<input type="text" name='POS_VAL_RUB_DT8' value="{POS_VAL_RUB_DT8}" class="form-control" placeholder="" style="width: 100%;">
							</div>
							<div class="col-sm-5" style="padding-bottom: 3%">
								<label for="bio">Commentaire</label>
						...
						<div class="col-sm-6 mt-5">
							...
							<div class="col3_partie" style="padding: 5%;">
								...
								<div class="form-group" style="margin: 1%">
									...
									<input type="text" name='POS_VAL_RUB_ETF' value="{POS_VAL_RUB_ETF}" class="form-control" style="width: 100%">
								</div>
								<!-- Historique -->
								<div class="form-group" style="margin: 1%">
