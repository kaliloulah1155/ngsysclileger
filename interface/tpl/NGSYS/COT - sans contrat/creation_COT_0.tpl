							...
							<div class="row">
								...
								<div class="col-sm-6">
									...
									<select id="select_contrat" name='POS_VAL_RUB_TYE' class="form-control type_contrat" style="width: 100%;">
										<option value="non" selected>Veuillez s&eacute;lectionner</option>
										...
										<table class="test tableTaches" style="width: 100%;margin: 2% auto;">
											<tbody class="tableL">
												<tr>
													...
													<td style="width: 100px;border:none;">
														<input name="montant_prime[]" type="text" min="0" placeholder="Montant de la prime" style="width: 100%;border: none;margin: 2px auto" class="form-control montant_prime">
													</td>
