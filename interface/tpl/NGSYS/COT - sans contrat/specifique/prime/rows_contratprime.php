    ...
    if ($find!=0){
           ...
           while ($row = pg_fetch_row($rq)) {
				 ...
				 $output .="
								...
								<td style='width: 100px;border:none;'>
									<input type='text' name='montant_prime[]'  value=".$row[1]." min='0' placeholder='Montant de la prime' style='width: 100%;border: none;margin: 2px auto' class='form-control montant_prime'>
								</td>
