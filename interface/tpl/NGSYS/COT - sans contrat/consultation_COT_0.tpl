							...
							<div class="row" style="margin-top: 0%">
								<div class="col-sm-12">
									...
									<div class="col2_partie" style="padding-top: 3%;">
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<select id="select_contrat" name='POS_VAL_RUB_TYE' class="form-control" style="width: 100%;">
									  ...
									  <input type="text" name="POS_VAL_RUB_EXT" value="{POS_VAL_RUB_EXT}" class="exist_contrat"   />

									  <!--activé ou desactivé un contrat -->
									  <input type="text" name="POS_VAL_RUB_ACT" value="{POS_VAL_RUB_ACT}" class="status_activ_cot"  />
												</div>
								...
								<div class="col-sm-12" id="col_partie_2" style="margin-top: 3%;display: none;">
										...
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-sm-4" style="margin-top: 13px;display: none;" id="volumeHoraiares">
													...
													<input type="text" name="POS_VAL_RUB_VHE" value="{POS_VAL_RUB_VHE}"   class="form-control" min="1" placeholder="Volume horaire" style="width: 100%;">
												</div>

												<div class="col-sm-4" style="margin-top: 13px;display: none;" id="nombreJours">
													<label>Nombre de jours</label>
													<input type="text" name="POS_VAL_RUB_NBR" value="{POS_VAL_RUB_NBR}" class="form-control"  placeholder="Nombre de jours" style="width: 100%;">
												</div>
												...
												<div class="col-sm-4" style="margin-top: 13px;display: none;" id="dateFinEssai">
													...
													<input type="text" name="POS_VAL_RUB_DFI" value="{POS_VAL_RUB_DFI}" id="dateFinEs" class="form-control datefin_essai" placeholder="jj/mm/aaaa" style="width: 100%;">
												</div>
									...
									<input type="hidden"  name="POS_VAL_RUB_M1" value="{POS_VAL_RUB_M1}"     class="mois_lettre" />
												...
												<div class="col-sm-4" style="margin-top: 13px;display: none;display: none;" id="dateFinContrats">
													...
													<input type="text" name="POS_VAL_RUB_DEC" value="{POS_VAL_RUB_DEC}"  id="dateFinConts ecole_datefin" class="form-control" placeholder="jj/mm/aaaa" style="width: 100%;">
												</div>
