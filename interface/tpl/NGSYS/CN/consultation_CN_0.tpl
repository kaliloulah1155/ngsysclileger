...
<head>
    ...
    <title>Consultation de CN</title>
...
<body  class='tpl_consultation tpl_consultation_cn' onLoad='initTplConsultation();{GRISE_CHAMP};' onBeforeUnLoad="{CODE_ACTION_UNLOAD}" style="background-color: transparent;font-family: 'Times New Roman';">
  <!-- <form name='principal' ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();'> -->

	<form name='principal' id='formCN' ACTION='{URL_ATTENTE}' method='POST'>
