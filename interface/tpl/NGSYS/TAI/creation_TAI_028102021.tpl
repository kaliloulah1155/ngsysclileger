		        ...
		        <div class="card-body">
		        	<div class="row" style="margin-bottom: 3%">
				        ...
				        <div class="col-sm-1" style="margin-top: 13px;">
				        	<label for="bio" style="visibility: hidden;"></label>
				            <button class="btn btn_format bg-primary  " title="cliquez pour exporter vos documents en format s&#233;lectionner" disabled="true">Exporter</button>
				        </div>
