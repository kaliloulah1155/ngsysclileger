...
<head>
    ...
    <title>Consultation type mission</title>
...
<body  class='tpl_consultation tpl_consultation_tym' onLoad='initTplConsultation();{GRISE_CHAMP};' onBeforeUnLoad="{CODE_ACTION_UNLOAD}" style="background-color: transparent;font-family: 'Times New Roman';">
								...
								<div class="col2_partie" style="padding-top: 3%;">
									...
									<div class="row">
										<div class="col-sm-4 form-group">
											...
											<input type="text" name='POS_VAL_RUB_HTE'  value="{POS_VAL_RUB_HTE}" placeholder="D&#233;signation 1" class="form-control" style="width: 100%;">
										</div>
										<div class="col-sm-4 form-group">
											<label for="bio">D&#233;signation 2</label>
											<input type="text" name='POS_VAL_RUB_NRR'  value="{POS_VAL_RUB_NRR}" placeholder="D&#233;signation 2" class="form-control" style="width: 100%;">
										</div>
										<div class="col-sm-4 form-group">
											<label for="bio">D&#233;signation 3</label>
											<input type="text"  name='POS_VAL_RUB_FTR'  value="{POS_VAL_RUB_FTR}" placeholder="D&#233;signation 3" class="form-control" style="width: 100%;">
										</div>
									</div>
