...
<body class="fluid">
    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: center;">Pr&#233;nom</th>
                <th style="min-width: 100px;text-align: left;">Projet</th>
                <!-- <th style="min-width: 100px;text-align: left;">Date depart en cong&#233;</th> -->
        ...
        <tbody class="list_mission">

           <!--  <tr>
                <th>1</th>
                <th>Kobenan</th>
                <th>Marcel</th>
                <th>mkqjergjkeokq$)o</th>
                <th>12/06/2013</th>
                <th>
    ...
    <!-- Les scripts de jquery pour l'optimisation de code  -->
    <script language='javascript' src="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/MIS/liste/listeAjaxMIS/load_liste_MIS.js"></script>
    <!-- <script language='javascript' src="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/PRS/excelmis/personneexcel.js"></script> -->
    ...
    <script>
        ...
        $(document).on('click','.modifier',function(){
            ...
            //alert(numposeidon);
          window.location.href='/<?php echo $_GET["APPLI"] ?>/interface/session/principal/consultation/consulter_index.php?MODE=MODIFICATION&POS_NUM_DOC='+numposeidon+'&POS_TYPEDOC=MIS&POS_NUM_FICHE=0';
        ...
        $(document).on('click','.supprimer',function(e){
                ...
                var link_url_del="/<?php echo $_GET['APPLI'] ?>/interface/tpl/<?php echo $_GET['APPLI'] ?>/MIS/liste/listeAjaxMIS/delete_MIS.php";
