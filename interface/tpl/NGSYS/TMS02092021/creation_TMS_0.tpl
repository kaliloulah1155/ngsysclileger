...
<body class='tpl_creation tpl_creation_tms' onLoad='initTplCreation(); 'style="background-color: transparent;font-family: 'Times New Roman';">
	<form name='principal' ACTION='{URL_ATTENTE}' class="cform" method='POST' onSubmit='return validerCreation();'>
		...
		<div style="display: flex; flex-direction: row; justify-content: space-around; margin-top: 1%;">
				...
				<input type="hidden" name='POS_VAL_RUB_MEL' class="viewemail" value="{NOM_UTILISATEUR}" >
		...
		<div class="col_list">
			...
			<a href="/{NOM_APPLICATION}/interface/tpl/{NOM_APPLICATION}/TMS/liste/liste_TMS_1.php?APPLI={NOM_APPLICATION}&USER={NOM_UTILISATEUR}&PROFIL={PROFIL_UTILISATEUR}">
				...
				<table class="test" id="table_tache" style="width: 100%;text-align: center; margin-top: 2%;">
					...
					<tbody class="tableL">
						<tr>
							...
							<td style="width: 80px;border:none;">
								<input type="number" onkeydown="limit(this);" onkeyup="limit(this);"  name="taux[]" step="1" min="1" max="100" style="width: 100%;" class="form-control taux"  id="resultat">
							</td>
							<td style="width: 80px;border:none;">
