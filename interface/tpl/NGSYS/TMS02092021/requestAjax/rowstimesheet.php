...
if ($find!=0){
         ...
         while ($row = pg_fetch_row($rq)) {
              ...
              $output .="
                        ...
                        <td style='width: 150px;border:none;'>
                              ...
                              <input type='text' name='activite[]'  value=".$row[1]." style='width: 100%;' class='form-control activite'>
                        </td>
                        ...
                        <td style='width: 80px;border:none;'>
                            <input type='time' name='heurein[]' value=".$row[3]." style='width: 100%;' class='form-control heurein'>
                        </td>
                        <td style='width: 80px;border:none;'>
                            <input type='time'  name='heureout[]'  value=".$row[4]." style='width: 100%;' class='form-control heureout'>
                        </td>
                        <td style='width: 80px;border:none;'>
                            <input type='text' name='duree[]'  value=".$row[5]." style='width: 100%;' class='form-control duree'>
                        </td>
                        <td style='width: 80px;border:none;'>
                            <input type='number' step='1' min='1' name='taux[]'  value='".$row[6]."' max='100' style='width: 100%;' class='form-control taux'  id='taux'>
                        </td>
                        <td style='width: 80px;border:none;'>
                            <input type='text' name='resultat[]'  value=".$row[7]." style='width: 100%;' class='form-control resultat'  id='resultat'>
                        </td>
                    </tr>
    ...
    $output .="
        ...
        <tr>
            ...
            <td style='width: 80px;border:none;'>
                <input type='number' name='taux[]' step='1' min='1' max='100' style='width: 100%;' class='form-control taux'  id='taux'>
            </td> 
