					...
					<div class="col12_partie" style="padding-top: 3%;">
						...
						<div class="row" style="margin: 0.5% 0%">
							...
							<div class="col-sm-3" style="margin-top: 5px">
								...
								<input type="text" name='POS_VAL_RUB_NPI' value="{POS_VAL_RUB_NPI}" equired="true" data-parsley-trigger="keyup" data-parsley-pattern="^[A-Z0-9 ]*$" placeholder="Num&eacute;ro de pi&egrave;ce" class="form-control numP" style="width: 100%;"/>
							</div>
						</div>
						...
						<div class="row" style="margin: 0.5% 0%">
							...
							<div class="col-sm-3" style="margin-top: 5px">
								...
								<input type="Number" name='POS_VAL_RUB_NEF' value="{POS_VAL_RUB_NEF}" placeholder="Nombre d&#146;enfant" min="0"max="50" class="form-control" style="width: 100%;"/>
							</div>
						</div>
