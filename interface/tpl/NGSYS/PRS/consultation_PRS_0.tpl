	 ...
	 <script>
	 	...
	 	var  selectmat ="";
			if($('.get_mode').val()=='CONSULTATION'){
                 ...
                 /*********** POUR LA VUE DE CONSULTATION *********************/
					  	 //Debut civilité-matrimoniale
		 let civil =$('.selectCivilite').val();
		 if (civil != "") {
			  switch (civil) {
					 case 'MME':
							selectmat="<option value='MARIEE'> Mari&eacute;e</option>";
							jQuery(".matrimoniale").prop("disabled", true);
		...
		//fin civilité-matrimoniale


			}else{

				 /*********** POUR LA VUE DE MODIFICATION *********************/
				//debut civilité à la modification
				   ...
				   if(selectCivilite == 'MME'){
					...
					//fin civilité à la modification
