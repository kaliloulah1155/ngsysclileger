								...
								<div class="col-sm-12 mt-5" style="margin-top: -5.6%;">
									...
									<div class="col12_partie" style="padding-top: 3%;">
										<div class="row" style="margin: 0.5% 0%">
											...
											<div class="col-sm-3" style="margin-top: 5px;">
												<label>Code</label>
												<input type="text" name='POS_VAL_RUB_COD' value="{POS_VAL_RUB_COD}" placeholder="Code"  class="form-control"  />
											</div>
										</div>
										...
										<div class="row" style="margin: 0.5% 0%">
											...
											<div class="col-sm-3" style="margin-top: 5px">
												<label>Commune</label>
												<input type="text" name='POS_VAL_RUB_CNE'value="{POS_VAL_RUB_CNE}" placeholder="Commune" class="form-control" data-parsley-trigger="keyup" data-parsley-pattern="^[a-zA-Z'_ ]*$" style="width: 100%;">
											</div>
											<div class="col-sm-3" style="margin-top: 5px">
												<label>Situation matrimoniale</label>
												<select id="selection" rows="1" name='POS_VAL_RUB_SIF' class="form-control"style="width: 100%;">
													<option value="" selected>Veuillez s&#233;lectionner</option>
