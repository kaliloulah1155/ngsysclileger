				...
				<div class="col-sm-12 mt-5">
					...
					<div class="col2_partie" style="padding: 10px;">
						<div class="row">
							...
							<div class="col-sm-4">
								<label for="bio">Fonction<span class='text'></span> :</label>
							...
							<div class="col-sm-4">
								<label for="bio">Nature de la santion<span class='text'></span> :</label>
						...
						<div class="row" style="margin-top: 13px">
							<div class="col-sm-4">
								<label for="bio">Date de defaute<span class='text'></span> :</label>
							...
							<div class="col-sm-4">
								<label>Date de demande d'explication<span class='text'></span> :</label>
							...
							<div class="col-sm-4">
								<label for="bio">Date de reception d'explication<span class='text'></span> :</label>
						...
						<div class="row" style="margin-top: 13px">
							<div class="col-sm-4">
								<label for="bio">Date de notification<span class='text'></span> :</label>
						...
						<div class="row" style="margin-top: 13px">
							<div class="col-sm-12">
								<label for="bio">Commentaires<span class='text'></span> :</label>
	...
	<!-- END JQUERY  -->
	 ...
	 <script>
		...
		$(document).ready(function () {
	        ...
	        $('#formsanct').submit(function(event){
