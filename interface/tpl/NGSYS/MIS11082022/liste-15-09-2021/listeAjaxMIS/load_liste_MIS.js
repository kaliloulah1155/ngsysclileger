            ...
            for (let i = 0; i < responseNew.length; i++) {
                t.row.add(
                    [
                        ...
                        responseNew[i][2],
                        responseNew[i][3],
                        "<a href='javascript:void(0)' class='modifier' data-num=" + responseNew[i][4] + " style='padding: 3px;margin: 5px;border: 1px solid black;cursor: pointer;'><i class='fa fa-eye'></i></a>" +
