										...
										<div class="col-sm-4" style="margin-top: 5%;">
											<div class="form-group">
											   <label for="bio">Montant emprunt :</label>
												<input type="text" placeholder="" name='POS_VAL_RUB_VEM' value="{POS_VAL_RUB_VEM}" class="form-control" id="bio" rows="1" style="width: 90%;resize: none"  data-parsley-required="true" data-parsley-pattern="^[0-9]+$" data-parsley-trigger="keyup">
											</div>
											<div class="form-group">
											   <label for="bio">Dur&eacute;e :</label>
							  					 <input type="text" name='POS_VAL_RUB_DUM' value="{POS_VAL_RUB_DUM}" placeholder="Nbres de mois" class="form-control" id="bio" rows="1" style="width: 90%;resize: none" data-parsley-required="true" data-parsley-trigger="keyup" data-parsley-pattern="[0-9][0-9]?">
											</div>
											<div class="form-group">
