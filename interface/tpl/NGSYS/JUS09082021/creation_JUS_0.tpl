					...
					<div class="col-sm-12 pt-2" style="border: 1px solid #4a67b3">
						...
						<div class="row mt-2 mb-3">
							<div class="col-sm-6">
								<div class="row">
									<div class="col-sm-6">
										<label for="bio">Dur&eacute;e <span class='text'></span> (en jour)</label>
										<input type="number" class="form-control duree" min="0" placeholder="Nombre de jours" name='POS_VAL_RUB_NBR' required="true" data-parsley-pattern="[0-9][0-9]?" data-parsley-trigger="keyup" value="{POS_VAL_RUB_NBR}"  id="d1" style="width: 100%">
									</div>
									<div class="col-sm-6">
										<label for="bio">Dur&eacute;e <span class='text'></span> (en heure)</label>
