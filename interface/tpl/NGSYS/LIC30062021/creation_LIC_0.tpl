					...
					<div class="col2_partie" style="padding-top: 2%;">
						<div class="row">
							...
							<div class="col-sm-4" style="margin-top: 13px">
								...
								<input type="text" name="POS_VAL_RUB_DFI" value="{POS_VAL_RUB_DFI}" placeholder="jj/mm/aaaa" class="form-control dateFin"  readonly='true' id="date2" style="width: 100%;">
							</div>
						...
						<div class="row" style="margin-top: 13px">
							<div class="col-sm-4">
								...
								<br>
								<input type="radio" class="val_1" name="POS_VAL_RUB_AUS" value="1" onclick="griser();">
								<label for="bio" style="margin-right: 3%">Oui</label>
								<input type="radio" class="val_1" name="POS_VAL_RUB_AUS" value="2" checked onclick="griser();">
