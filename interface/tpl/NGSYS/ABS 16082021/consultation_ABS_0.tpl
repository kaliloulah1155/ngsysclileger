						...
						<nav class="container-fluid">
							<div class="row" style="margin-top: 1%">
											...
											<div class="row" style="margin-top: 2%">
												<div class="col-sm-6">
												   <label for="bio">Motif :</label>
													<textarea  name='POS_VAL_RUB_COM'class="form-control" id="motif" readonly="true"  data-parsley-required="true" data-parsley-trigger="keyup" rows="2"  style="width: 100%;resize: none">{POS_VAL_RUB_COM} </textarea>
												</div>
												<div class="col-sm-6">
								...
								<input type="hidden" name='POS_VAL_CTRL_INT' class="interselect" id='POS_VAL_CTRL_INT' value='{POS_VAL_RUB_INT}'>
										...
										<!-- 12_ 2 infos -->
								<div class="col-sm-12 mt-5"style="margin-top: 3%; margin-bottom: 2%">
									<div class="col1_partie text-center">
					...
					<div class="row jumbotron" style="margin: auto;padding: 12px">
						...
						<div class="acteur1">
							...
							<div class="col-sm-5" style="padding-bottom: 3%">
								...
								<textarea class="form-control" id="bio" rows="3" name='POS_VAL_RUB_CT1' style="width: 150%;resize: none">{POS_VAL_RUB_CT1}</textarea>
							</div>
						</div>
						...
						<div class="acteur2">
							...
							<div class="col-sm-5" style="padding-bottom: 3%">
								<label for="bio">Commentaire</label>
								<textarea class="form-control" id="bio" name='POS_VAL_RUB_CT2' rows="3" style="width: 150%;resize: none">{POS_VAL_RUB_CT2}</textarea>
							</div>
						</div>
						<!-- acteur 3 -->
						<div class="acteur3">
							...
							<div class="col-sm-5" style="padding-bottom: 3%">
								<label for="bio">Commentaire</label>
								<textarea class="form-control" id="bio" rows="3" name='POS_VAL_RUB_CT3' style="width: 150%;resize: none">{POS_VAL_RUB_CT3}</textarea>
							</div>
						</div>
					</div>
