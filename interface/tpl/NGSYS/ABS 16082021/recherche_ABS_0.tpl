	...
	<form name='principal' ACTION='{URL_ATTENTE}' method='POST' onSubmit='return validerCreation();'>
		...
		<nav class="container-fluid">
				...
				<div class="col-sm-6 mt-5" style="margin-top: -5.6%;">
					...
					<div class="col2_partie" style="padding-top: 5%;">
						...
						<div class="form-group">
						   ...
						   <input type="text" name="POS_VAL_RUB_NOM" value="{POS_VAL_RUB_NOM}" class="form-control">
						</div>
						<div class="form-group">
			...
			<div class="row col_btn">
				...
				<div type="submit" class="btn col-sm-2" style="font-size: 12px;" style="margin-left: 5%;">RECHERCHER</div>
			</div>  
		</nav>
