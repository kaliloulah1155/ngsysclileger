...
require('../../../../../configuration_w/tcpdf-master/tcpdf.php');
   ...
   $output='';
    ...
    $data = array() ;
     ...
     $query_init="
            ...
            \"COD\",\"DCR\",\"NUD\"
           FROM 
                public.pos_tab_index_cas ORDER BY  \"DCR\" ASC
           ";
    ...
    $query_cas_date="
            ...
            WHERE  \"DCR\" BETWEEN '".$date_deb."' AND '".$date_fin."' ORDER BY  \"DCR\" ASC
           ";
   ...
   while ($row = pg_fetch_row($contests_cas)) {
...
$pdf->SetTitle('CONSOMMATION ASSUREE');
...
<!-- BEGIN CONTENT -->
 ...
 <p>
        ...
        <table class="jour"  align="center" cellpadding="2" border="1" width="100%">
	        <tr>
	           <td   style="background-color:#2AD4FF;">CODE</td>
	           <td   style="background-color:#2AD4FF;">DATE DE CREATION</td>
	           <td   style="background-color:#2AD4FF;">NUMERO </td>
	        </tr>
...
$pdf->Output('conso_assuree.pdf', 'I');
