...
<body class='tpl_recherche_fiche tpl_recherche_fiche_pay' onLoad='initTplRecherche();'>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="ts-service-info" >
							<fieldset class="side-by-side panel panel-primary" style="margin: 110px auto;">
								...
								<article class="fields-row" style="text-align:center;">   
									 <span class="col-lg-6 group1" >
											<span style="border: 1px solid; padding: 2px; float:right;margin-right: 5%;display: none;" class="d-inline-block">
												<a href="javascript:charger_vocabulaire(document.principal.POS_TYPEDOC.value, 'CRE', 'POS_VAL_RUB_CRE')"><span class='iconvocmonolie' id='img_voc_CRE' title='Libellé'></span></a>
											</span>
											<span class="input-group d-inline-block">
												<label class="input-group-addon" for="id_rub_MEL" >E-mail </label>
												<input class="form-control email"  name='POS_VAL_RUB_MEL' id='id_rub_MEL'  value="{POS_VAL_RUB_MEL}"  onBlur="javascript:maximum(this,'119')" style="width: 25%;"
									...
									&nbsp;&nbsp;
									 <span class="col-lg-6 group1">
												<label class="input-group-addon" for="id_rub_A1" >Mois & Date </label>
												<input type="text" name='POS_VAL_RUB_A1' value='{POS_VAL_RUB_A1}' placeholder="MM/AAAA" class="form-control date" style="width: 25%;" >
									</span>
								</article>
							</fieldset>
						</div>
