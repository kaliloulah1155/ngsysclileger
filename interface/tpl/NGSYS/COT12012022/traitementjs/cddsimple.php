...
<p>
Par ce contrat, la société '.$entreprise.' sollicite '.$civilite.' '.$nom.' '.$prenoms.' qui accepte d’exécuter une prestation intellectuelle en qualité '.strtoupper($fonction).' , dans le cadre d’un contrat de travail à durée déterminée,  conformément à sa fiche de poste annexé au présent contrat. '.$majdeterminant.' exercera ses fonctions sous l’autorité et selon les directives de la Direction Générale de '.$entreprise.' à qui '.$determinant.' rendra compte de ses prestations de travail.
</p>
