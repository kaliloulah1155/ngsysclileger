...
<head>
    ...
    <title>Consultation type de formation</title>
...
<body  class='tpl_consultation tpl_consultation_tfo' onLoad='initTplConsultation();{GRISE_CHAMP};' onBeforeUnLoad="{CODE_ACTION_UNLOAD}" style="background-color: transparent;font-family: 'Times New Roman';">
							...
							<div class="col3_partie" style="padding: 5%;">
								...
								<div class="form-group">
								   <label for="bio">Suppression :</label>
									<textarea  class="form-control"  name='POS_VAL_RUB_AMO' id="bio" rows="2" style="width: 90%;resize: none;margin-top: -1%">{POS_VAL_RUB_ASU}</textarea>
								</div>
							</div>
						</div>
					</div>
