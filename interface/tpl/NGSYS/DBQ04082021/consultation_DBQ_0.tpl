...
if($('.cbk1').val()=="OUI"){
	...
	$('#formDBQ').parsley();
	  ...
	  //console.log(bouton_exec);

	//affichage en fonction du MODE sur le Formulaire  if($('.get_mode').val()=='CONSULTATION' || $('.bouton_sub').val()=='{LIBELLE_ACTION_HERMES}'){
 	/*if($('.bouton_sub').val()=="{LIBELLE_ACTION_HERMES}"){ 
		$('.btn').hide();
	}*/
