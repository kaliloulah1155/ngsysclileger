		       ...
		       ///tableau
		       	...
		       	var html = '';
					    ...
					    html += '</td>' +   
								...
								'</td>'+
								'<td>'+
										'<input type="checkbox" name="hsu[]"  style="margin-left:50%;width:30%" class="form-control hsu"   >'+
								'</td>'+
								'<td>'+
										'<input type="checkbox" name="ferie[]" style="margin-left:50%;width:30%" class="form-control ferie" >'+
								'</td>'+
					    '</tr>';
