				...
				if (!$result){
					...
					while ($row = pg_fetch_row($result)) {
					  //echo "$row[0] - $row[1] - $row[2] - $row[3]";
						...
						$t->set_var("URL_QUESTION_SIMPLE", URL_SITE."/interface/session/principal/recherche/recherchesimple.php?&POS_TYPEDOC=".$_REQUEST['POS_TYPEDOC']); // url pour aller un template personnalis�
