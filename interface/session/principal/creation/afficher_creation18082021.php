...
/*var_dump($_SESSION["sess_tabQuestBibPub"]); 
//var_dump($_REQUEST);
exit; */
		...
		if($_REQUEST['POS_TYPEDOC']=='ABS'
		      OR $_REQUEST['POS_TYPEDOC']=='PRT' OR $_REQUEST['POS_TYPEDOC']=='DEM' OR $_REQUEST['POS_TYPEDOC']=='TMS' OR
			   $_REQUEST['POS_TYPEDOC']=='DBQ' OR $_REQUEST['POS_TYPEDOC']=='JUS'
			    OR $_REQUEST['POS_TYPEDOC']=='ATT' OR $_REQUEST['POS_TYPEDOC']=='TBD' OR $_REQUEST['POS_TYPEDOC']=='COT'
			    ){
			...
			//Recup�ration des donn�es de l'utlisateurs connect�
				$result = pg_query($conn, "SELECT \"NOM\" , \"PRE\" ,\"FON\", \"DPT\" , \"SLT\" from pos_tab_index_prs WHERE \"MEL\"='".$_SESSION["sess_user_name"]."'");
