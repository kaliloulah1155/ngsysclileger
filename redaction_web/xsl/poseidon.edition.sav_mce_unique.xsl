...
<xsl:stylesheet
    ...
    <xsl:copy>
      ...
      <script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript">
        tinyMCE.init({
          ...
          theme : "advanced",
          language : "fr",
          elements : "textarea_commun_postext",
  ...
  <xsl:template match="xhtml:body">
    ...
    <xsl:copy>
      ...
      <form xmlns="http://www.w3.org/1999/xhtml" name="principal" method="POST" enctype="application/octet-stream">
        <xsl:text>&#xA;</xsl:text>
        ...
        <!-- Ajout du champs TinyMCE utilisée pour la saisie de toutes les sections de texte riche-->
        <div xmlns="http://www.w3.org/1999/xhtml">
            <xsl:attribute name="id">div_commun_postext</xsl:attribute>
            <textarea xmlns="http://www.w3.org/1999/xhtml">
                <xsl:attribute name="rows">20</xsl:attribute>
                <xsl:attribute name="cols">90</xsl:attribute>
                <xsl:attribute name="id"><xsl:text>textarea_commun_postext</xsl:text></xsl:attribute>
                <xsl:attribute name="name"><xsl:text>textarea_commun_postext</xsl:text></xsl:attribute>
            <xsl:text> </xsl:text>
            </textarea>
        </div>
      </form>
