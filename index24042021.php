...
<br>
<img src="images/logo/ngser.png" width="300" style="margin-top: 7%; border-radius: 5px;" alt="Poseidon">
</div>
<br>

<div style='background-color: rgba(255,255,255,0.80);  width: 50%;margin: auto;margin-top:calc(100vh - 560px);text-align: center;padding:30px;'>
...
?>                    
    ...
    <table>
            ...
            <span style="font-weight:bold;font-size:inherit;text-align:center;font-family:'Times New Roman'">Vous êtes déjà connecté(e)</span><br><br>
                    Une session de cette application est déjà ouverte dans une fenêtre ou un onglet de ce navigateur. <br><br>
                    Vous pouvez continuer dans la session déjà ouverte. <br><br> 
...
<font face="'Times New Roman'" style="color:#FFFFFF";>Nouvelle Génération de Service</font>
</div>
</div>
</body>
</html>
