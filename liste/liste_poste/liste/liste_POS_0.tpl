    ...
    <div class="card mb-1" >
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-1 mt-5 offset-2">
    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: center;">Intitul&#233; du poste</th>
                <th style="min-width: 100px;text-align: center;">D&#233;partement</th>
                <th style="min-width: 100px;text-align: left;">Service</th>
                <!-- <th style="min-width: 100px;text-align: left;">Hi&#233;rarchie op&#233;rationnelle</th> -->
                <!-- <th style="min-width: 100px;text-align: left;">Hi&#233;rarchie fonctionnelle</th> -->
