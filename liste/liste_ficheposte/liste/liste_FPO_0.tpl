    ...
    <div class="card mb-1" >
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>Titulaire du poste</label>
    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: center;">Titulaire du poste</th>
                <th style="min-width: 100px;text-align: center;">Intitul&#233; du poste</th>
                <th style="min-width: 100px;text-align: left;">Type de recrutement</th>
