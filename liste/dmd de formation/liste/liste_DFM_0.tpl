    ...
    <table id="min-data" class="test table"> <!--   id="languages" un element important display -->
        <thead class="table-sm table-hover text-white" style="background: #4a67b3;">
            <tr>
                ...
                <th style="min-width: 100px;text-align: center;">Intitul&#233; de l&#146;action de formation</th>
                <th style="min-width: 100px;text-align: center;">But de formation</th>
                <!-- <th style="min-width: 100px;text-align: left;">Entreprise</th> -->
