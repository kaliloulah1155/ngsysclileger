    ...
    (function() {
        ...
        $.extend($.effects, {
            ...
            unshift: function(element, queueLength, count) {
                ...
                if (queueLength > 1) {
                    queue.splice.apply(
                        queue, [1, 0].concat(queue.splice(queueLength, count))
                    );
                }
                element.dequeue();
            },
        ...
        nextPage: function(event) {
            ...
            if (this._hasScroll()) {
                ...
                this.focus(
                    event,
                    this.activeMenu
                    .find(this.options.items)[!this.active ? "first" : "last"]()
                );
            }
        },
        ...
        _attachHandlers: function(inst) {
            ...
            inst.dpDiv.find("[data-handler]").map(function() {
                var handler = {
                    ...
                    selectDay: function() {
                        $.datepicker._selectDay(
                            id, +this.getAttribute("data-month"), +this.getAttribute("data-year"),
                            this
                        );
                        return false;
                    },
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _create: function() {
            ...
            $.extend(this, {
                ...
                _helper: o.helper || o.ghost || o.animate ?
