...
function onPartager(szInfoStruQuest)
{
	...
	if(szUrlPartageQuest.length > 0)
        parent.modelesswinyui(szUrlPartageQuest, "Detail", {width: 800, height: 400, left: 150, top: 150});
    hide_popup_menu();
}
...
function onConsulter(szInfoStruQuest)
{
	...
	if(szUrlDetailQuest.length > 0)
        parent.modelesswinyui(szUrlDetailQuest, "Detail", {width: 700, height: 400, left: 150, top: 150});
    hide_popup_menu();
}
