...
function onAction(fctName)
{
    ...
    if (fctName == "onConsulter" || fctName == "onModifier") {
        ...
        arr.map(function(paramurl) {
            ...
            parent.openPosDocument(sUrl + paramurl);
        });
    }
        ...
        return parent.modelesswinyui(szUrlImprimerLR, "Impression", {width: CST_WIDTH_IMP, height: CST_HEIGHT_IMP, left: CST_LEFT_IMP, top: CST_TOP_IMP});
    }
        ...
        return parent.modelesswinyui(szUrlExporter, "Exportation", {width: CST_WIDTH_ASSO, height: CST_HEIGHT_ASSO, left: CST_LEFT_ASSO, top: CST_TOP_ASSO});
    }   
    	...
    	szUrlExporter += "&POS_NUMDOS=" + document.principal.POS_NUMDOS.value;
        szUrlExporter += "&LISTE_NUMDOC="  +  ((nbDocumentSelect > 0) ? getListeNumInfo(false) : "");
        return parent.modelesswinyui(szUrlExporter, "Mise à jour en rafale", {width: 600, height: 450, left: CST_LEFT_ASSO, top: CST_TOP_ASSO});
    }
    else if(fctName == "onConsulterAttributs") {
        var sUrl = getUrlReponse("URL_CONSULTER_ATTRIBUT")+arr[0];
            ...
            if (searchReq.readyState == 4 || searchReq.readyState == 0)
        	{
        	   ...
        	   if (searchReq.readyState == 4 || searchReq.readyState == 0)
        	   {
            	   	...
            	   	if (objAction.code_retour == 1)
            	   	{
                        ...
                        parent.openPosDocument(sUrlAtt);			
        			}
        			else
