...
{
    var tabElementObligatoire = document.querySelectorAll('label.labelObligatoireType + .inputChampType');
    var bCreactionOk = true;
    // attention aux btn radio et select
    for (var i=0;i<tabElementObligatoire.length;i++) {
