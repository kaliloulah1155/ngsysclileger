...
{
    var bRetour = parent.testOpenDocument(false);
    if (bRetour)
	{
		if (typePage == 'accueil')
		{
		...
		else if (typePage == 'lien_creation' || szUrl.indexOf('creation/afficher_creation.php') != -1 ||
            szUrl.indexOf('afficher_type.php?ACTION=CREATION') != -1)
		{
