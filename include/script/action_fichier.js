...
function onSupprimer(szInfoPage)
{
    ...
    {
        var tabInfoPage = szInfoPage.split("|");
        document.form_fichier.action = "../gestionfichier/action_fichier.php";
...
function onAjouteFinDeSsPage(szInfoPage)
{
    var tabInfoPage = szInfoPage.split("|");
    document.form_fichier.POS_NUM_DOC.value = tabInfoPage[0];
    document.form_fichier.choixFichier.value = tabInfoPage[1]+"."+(parseInt(eval("document.principal.NB_SS_PAGE_"+tabInfoPage[1]+".value"))+1);
    afficheFormFichier();
}
